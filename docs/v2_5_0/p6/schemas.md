...
- [ActivationExtensionStatusFields](#activationextensionstatusfields)
- [ActivationRunCollection](#activationruncollection)
- [ActivationRunResponse](#activationrunresponse)
- [ActivationSiteStatus](#activationsitestatus)
- [ActivationStatusResponse](#activationstatusresponse)
- [AgentControllerCertificateSettings](#agentcontrollercertificatesettings)
- [AlwaysBulk](#alwaysbulk)
- [Api400CustomError](#api400customerror)
- [Api400DefaultError](#api400defaulterror)
- [Api400DefaultErrorE40947496A3FF3F8](#api400defaulterrore40947496a3ff3f8)
...
- [Api403DefaultError204133A3D11A4DB0](#api403defaulterror204133a3d11a4db0)
...
- [Api404DefaultErrorBFBB02DDEB1EED3A](#api404defaulterrorbfbb02ddeb1eed3a)
- [Api405CustomError](#api405customerror)
- [Api405DefaultError](#api405defaulterror)
- [Api406DefaultError](#api406defaulterror)
- [Api406DefaultErrorA94076090B8FA3C0](#api406defaulterrora94076090b8fa3c0)
...
- [Api412DefaultError503AC946C2F53BB7](#api412defaulterror503ac946c2f53bb7)
- [Api415DefaultError](#api415defaulterror)
- [Api415DefaultError3A6CC372948DF091](#api415defaulterror3a6cc372948df091)
...
- [Api428DefaultError5ADDC6B86D2885E1](#api428defaulterror5addc6b86d2885e1)
...
- [BackgroundJobException](#backgroundjobexception)
- [BackgroundJobSnapshot](#backgroundjobsnapshot)
- [BackgroundJobSnapshotObject](#backgroundjobsnapshotobject)
- [BackgroundJobStatus](#backgroundjobstatus)
- [BackgroundJobStatus1](#backgroundjobstatus1)
- [BackgroundJobStatusObject](#backgroundjobstatusobject)
- [BaseUserAttributes](#baseuserattributes)
- [BasicAuthExplicit](#basicauthexplicit)
- [BasicAuthStorePassword](#basicauthstorepassword)
- [BasicSettingsCreateModel](#basicsettingscreatemodel)
- [BasicSettingsEditModel](#basicsettingseditmodel)
- [BasicSettingsModel](#basicsettingsmodel)
- [BinaryExpr](#binaryexpr)
- [BindCredentialsExplicitPasswordRequest](#bindcredentialsexplicitpasswordrequest)
- [BindCredentialsPasswordTypeSelectorRequest](#bindcredentialspasswordtypeselectorrequest)
- [BindCredentialsSelectorRequest](#bindcredentialsselectorrequest)
- [BindCredentialsStoreIdRequest](#bindcredentialsstoreidrequest)
- [BrokerConnectionConfig](#brokerconnectionconfig)
- [BrokerConnectionExtension](#brokerconnectionextension)
- [BrokerConnectionRequestCreate](#brokerconnectionrequestcreate)
- [BrokerConnectionRequestUpdate](#brokerconnectionrequestupdate)
- [BrokerConnectionResponse](#brokerconnectionresponse)
- [BrokerConnectionResponseCollection](#brokerconnectionresponsecollection)
...
- [CancelPreviousNotification](#cancelpreviousnotification)
...
- [CheckboxWithListOfTypedResponders](#checkboxwithlistoftypedresponders)
...
- [ConnectedSiteAttributes](#connectedsiteattributes)
- [ConnectionMode](#connectionmode)
- [ConnectionModel](#connectionmodel)
- [ContactGroup](#contactgroup)
- [ContactGroupCollection](#contactgroupcollection)
- [ContactGroupExtensions](#contactgroupextensions)
...
- [CreateConfigurationEntity](#createconfigurationentity)
...
- [CreateInHostLocation](#createinhostlocation)
- [CreateNotificationsWithCustomParameters](#createnotificationswithcustomparameters)
- [CreateNotificationsWithParameters](#createnotificationswithparameters)
...
- [DeleteDowntimeByHostGroup](#deletedowntimebyhostgroup)
...
- [DeleteDowntimeByServiceGroup](#deletedowntimebyservicegroup)
- [DeleteECEvents](#deleteecevents)
- [Direct](#direct)
- [DirectMapping](#directmapping)
- [DirectoryTypeAutoRequest](#directorytypeautorequest)
- [DirectoryTypeManualRequest](#directorytypemanualrequest)
- [DirectoryTypeSelectorRequest](#directorytypeselectorrequest)
...
- [EditConfigurationEntityResponse](#editconfigurationentityresponse)
...
- [FixedDowntimeMode](#fixeddowntimemode)
- [FlexibleDowntimeMode](#flexibledowntimemode)
- [Folder](#folder)
...
- [FolderResponseCollection](#folderresponsecollection)
...
- [GETLdapConnection404](#getldapconnection404)
...
- [HostGroupExtensions](#hostgroupextensions)
...
- [InventoryPathAllowAll](#inventorypathallowall)
- [InventoryPathForbidAll](#inventorypathforbidall)
- [InventoryPathSpecificPath](#inventorypathspecificpath)
- [InventoryPathSpecificPaths](#inventorypathspecificpaths)
- [InventoryPaths](#inventorypaths)
- [JiraPluginCreate](#jiraplugincreate)
- [JobLogs](#joblogs)
- [JsmOperationsPluginCreate](#jsmoperationsplugincreate)
- [JsmTypedResponder](#jsmtypedresponder)
- [LDAPBindCredentials](#ldapbindcredentials)
- [LDAPCheckboxCustomTimeRangeEnabledRequest](#ldapcheckboxcustomtimerangeenabledrequest)
- [LDAPCheckboxDisabledRequest](#ldapcheckboxdisabledrequest)
- [LDAPConnectTimeout](#ldapconnecttimeout)
- [LDAPConnectTimeoutRequest](#ldapconnecttimeoutrequest)
- [LDAPConnectTimeoutSelectorRequest](#ldapconnecttimeoutselectorrequest)
- [LDAPConnection](#ldapconnection)
- [LDAPConnectionConfig](#ldapconnectionconfig)
- [LDAPConnectionConfigCreateRequest](#ldapconnectionconfigcreaterequest)
- [LDAPConnectionConfigUpdateRequest](#ldapconnectionconfigupdaterequest)
- [LDAPConnectionCreateRequest](#ldapconnectioncreaterequest)
- [LDAPConnectionResponse](#ldapconnectionresponse)
- [LDAPConnectionResponseCollection](#ldapconnectionresponsecollection)
- [LDAPConnectionSuffix](#ldapconnectionsuffix)
- [LDAPConnectionSuffixCreateRequest](#ldapconnectionsuffixcreaterequest)
- [LDAPConnectionSuffixCreateSelectorRequest](#ldapconnectionsuffixcreateselectorrequest)
- [LDAPConnectionSuffixUpdateRequest](#ldapconnectionsuffixupdaterequest)
- [LDAPConnectionSuffixUpdateSelectorRequest](#ldapconnectionsuffixupdateselectorrequest)
- [LDAPConnectionUpdateRequest](#ldapconnectionupdaterequest)
- [LDAPContactGroupMembership](#ldapcontactgroupmembership)
- [LDAPCustomTimeRangeSelector](#ldapcustomtimerangeselector)
- [LDAPDirectoryTypeConnection](#ldapdirectorytypeconnection)
- [LDAPDisableNotificationsValue](#ldapdisablenotificationsvalue)
- [LDAPEnableGroupsToRoles](#ldapenablegroupstoroles)
- [LDAPFromToFields](#ldapfromtofields)
- [LDAPGeneralProperties](#ldapgeneralproperties)
- [LDAPGeneralPropertiesCreateRequest](#ldapgeneralpropertiescreaterequest)
- [LDAPGeneralPropertiesUpdateRequest](#ldapgeneralpropertiesupdaterequest)
- [LDAPGroupSearchFilter](#ldapgroupsearchfilter)
- [LDAPGroupSearchFilterRequest](#ldapgroupsearchfilterrequest)
- [LDAPGroupSearchFilterSelector](#ldapgroupsearchfilterselector)
- [LDAPGroups](#ldapgroups)
- [LDAPGroupsRequest](#ldapgroupsrequest)
- [LDAPGroupsToAttributes](#ldapgroupstoattributes)
- [LDAPGroupsToRoles](#ldapgroupstoroles)
- [LDAPGroupsToRolesSelector](#ldapgroupstorolesselector)
- [LDAPGroupsToSyncDisableNotifications](#ldapgroupstosyncdisablenotifications)
- [LDAPGroupsToSyncSelector](#ldapgroupstosyncselector)
- [LDAPGroupsToSyncStartURL](#ldapgroupstosyncstarturl)
- [LDAPMemberAttributeRequest](#ldapmemberattributerequest)
- [LDAPMemberAttributeSelector](#ldapmemberattributeselector)
- [LDAPMemberAttributeValue](#ldapmemberattributevalue)
- [LDAPOther](#ldapother)
- [LDAPOtherRequest](#ldapotherrequest)
- [LDAPPageSize](#ldappagesize)
- [LDAPPageSizeRequest](#ldappagesizerequest)
- [LDAPPageSizeSelectorRequest](#ldappagesizeselectorrequest)
- [LDAPResponseTimeout](#ldapresponsetimeout)
- [LDAPResponseTimeoutRequest](#ldapresponsetimeoutrequest)
- [LDAPResponseTimeoutSelectorRequest](#ldapresponsetimeoutselectorrequest)
- [LDAPRoleElement](#ldaproleelement)
- [LDAPRoleElementRequest](#ldaproleelementrequest)
- [LDAPSyncInterval](#ldapsyncinterval)
- [LDAPSyncIntervalRequest](#ldapsyncintervalrequest)
- [LDAPSyncPluginAlias](#ldapsyncpluginalias)
- [LDAPSyncPluginAttributeRequest](#ldapsyncpluginattributerequest)
- [LDAPSyncPluginAttrubuteSelector](#ldapsyncpluginattrubuteselector)
- [LDAPSyncPluginAuthExp](#ldapsyncpluginauthexp)
- [LDAPSyncPluginDisableNotifications](#ldapsyncplugindisablenotifications)
- [LDAPSyncPluginEmailAddress](#ldapsyncpluginemailaddress)
- [LDAPSyncPluginGroupAllOthersRequest](#ldapsyncplugingroupallothersrequest)
- [LDAPSyncPluginGroupDisableNotificationsRequest](#ldapsyncplugingroupdisablenotificationsrequest)
- [LDAPSyncPluginGroupStartURLRequest](#ldapsyncplugingroupstarturlrequest)
- [LDAPSyncPluginGroupsToAttributesRequest](#ldapsyncplugingroupstoattributesrequest)
- [LDAPSyncPluginGroupsToAttributesSelector](#ldapsyncplugingroupstoattributesselector)
- [LDAPSyncPluginGroupsToContactGroupsSelector](#ldapsyncplugingroupstocontactgroupsselector)
- [LDAPSyncPluginGroupsToSyncSelector](#ldapsyncplugingroupstosyncselector)
- [LDAPSyncPluginGroupsValueRequest](#ldapsyncplugingroupsvaluerequest)
- [LDAPSyncPluginMenuIcons](#ldapsyncpluginmenuicons)
- [LDAPSyncPluginNavBarIcons](#ldapsyncpluginnavbaricons)
- [LDAPSyncPluginNestedOtherConnectionsRequest](#ldapsyncpluginnestedotherconnectionsrequest)
- [LDAPSyncPluginPager](#ldapsyncpluginpager)
- [LDAPSyncPluginShowMode](#ldapsyncpluginshowmode)
- [LDAPSyncPluginSideBarPosition](#ldapsyncpluginsidebarposition)
- [LDAPSyncPluginStartURL](#ldapsyncpluginstarturl)
- [LDAPSyncPluginTempUnit](#ldapsyncplugintempunit)
- [LDAPSyncPluginUITheme](#ldapsyncpluginuitheme)
- [LDAPSyncPluginVisibilityOfHostsOrServices](#ldapsyncpluginvisibilityofhostsorservices)
- [LDAPSyncPlugins](#ldapsyncplugins)
- [LDAPSyncPluginsRequest](#ldapsyncpluginsrequest)
- [LDAPTCPPort](#ldaptcpport)
- [LDAPTCPPortRequest](#ldaptcpportrequest)
- [LDAPTCPPortSelectorRequest](#ldaptcpportselectorrequest)
- [LDAPUserGroupFilter](#ldapusergroupfilter)
- [LDAPUserGroupFilterRequest](#ldapusergroupfilterrequest)
- [LDAPUserGroupFilterRequestSelector](#ldapusergroupfilterrequestselector)
- [LDAPUserIDAttribute](#ldapuseridattribute)
- [LDAPUserIDAttributeRequest](#ldapuseridattributerequest)
- [LDAPUserIDAttributeRequestSelector](#ldapuseridattributerequestselector)
- [LDAPUserSearchFilter](#ldapusersearchfilter)
- [LDAPUserSearchFilterRequest](#ldapusersearchfilterrequest)
- [LDAPUserSearchFilterRequestSelector](#ldapusersearchfilterrequestselector)
- [LDAPUsers](#ldapusers)
- [LDAPUsersRequest](#ldapusersrequest)
- [LDAPVersion](#ldapversion)
- [LDAPVersionRequest](#ldapversionrequest)
- [LDAPVersionSelectorRequest](#ldapversionselectorrequest)
...
- [ListOfExtraProperties](#listofextraproperties)
- [ListOfExtraPropertiesOneOf](#listofextrapropertiesoneof)
- [ListOfStrOneOf](#listofstroneof)
- [ListOfTypedRespondersOneOf](#listoftypedrespondersoneof)
...
- [ModifyDowntimeByHostGroup](#modifydowntimebyhostgroup)
...
- [ModifyDowntimeByServiceGroup](#modifydowntimebyservicegroup)
...
- [NotificationParamResponse](#notificationparamresponse)
- [NotificationParamResponseCollection](#notificationparamresponsecollection)
...
- [Oauth2ConnectionResponse](#oauth2connectionresponse)
- [Oauth2ConnectionResponseCollection](#oauth2connectionresponsecollection)
...
- [PasswordStorePasswordResponse](#passwordstorepasswordresponse)
- [PasswordStorePasswordResponseCollection](#passwordstorepasswordresponsecollection)
...
- [ProxyParamsModel](#proxyparamsmodel)
- [ProxyTcpModel](#proxytcpmodel)
- [PushOverOneOf](#pushoveroneof)
- [PushOverPluginCreate](#pushoverplugincreate)
- [PushOverPriority](#pushoverpriority)
- [PushOverPriorityBase](#pushoverprioritybase)
- [PushOverPriorityEmergency](#pushoverpriorityemergency)
- [PushOverPrioritySelector](#pushoverpriorityselector)
- [QuickSetupButton](#quicksetupbutton)
- [QuickSetupButtonIcon](#quicksetupbuttonicon)
- [QuickSetupCompleteResponse](#quicksetupcompleteresponse)
- [QuickSetupCompleteStageResponse](#quicksetupcompletestageresponse)
- [QuickSetupFinalActionRequest](#quicksetupfinalactionrequest)
- [QuickSetupGuidedResponse](#quicksetupguidedresponse)
- [QuickSetupOverviewResponse](#quicksetupoverviewresponse)
- [QuickSetupResponse](#quicksetupresponse)
- [QuickSetupStageActionRequest](#quicksetupstageactionrequest)
- [QuickSetupStageActionResponse](#quicksetupstageactionresponse)
- [QuickSetupStageOverviewResponse](#quicksetupstageoverviewresponse)
- [QuickSetupStageRequest](#quicksetupstagerequest)
- [QuickSetupStageStructure](#quicksetupstagestructure)
- [ReferTo](#referto)
- [RegexpRewrites](#regexprewrites)
- [RegisterHost](#registerhost)
- [RemoveProblemAcknowledgement](#removeproblemacknowledgement)
...
- [RuleFormSpecResponse](#ruleformspecresponse)
- [RuleFormSpecResponseCollection](#ruleformspecresponsecollection)
...
- [ServiceDiscoveryResultCheckTableValue](#servicediscoveryresultchecktablevalue)
- [ServiceDiscoveryResultCheckTableValueExtensions](#servicediscoveryresultchecktablevalueextensions)
- [ServiceDiscoveryResultExtensions](#servicediscoveryresultextensions)
- [ServiceDiscoveryResultHostLabelValue](#servicediscoveryresulthostlabelvalue)
- [ServiceDiscoveryRun](#servicediscoveryrun)
- [ServiceDiscoveryRunExtensions](#servicediscoveryrunextensions)
- [ServiceDiscoveryRunLogs](#servicediscoveryrunlogs)
...
- [ServiceGroupExtensions](#servicegroupextensions)
...
- [ServiceParametersWithHost](#serviceparameterswithhost)
...
- [SiteConnectionCreate](#siteconnectioncreate)
- [SiteConnectionCreateModel](#siteconnectioncreatemodel)
- [SiteConnectionEdit](#siteconnectionedit)
- [SiteConnectionEditModel](#siteconnectioneditmodel)
- [SiteConnectionExtensionsModel](#siteconnectionextensionsmodel)
- [SiteConnectionModel](#siteconnectionmodel)
- [SiteIDPrefixOneOf](#siteidprefixoneof)
- [SiteId](#siteid)
- [SiteLoginCredentials](#sitelogincredentials)
- [SiteManagementCollectionModel](#sitemanagementcollectionmodel)
...
- [StatusConnectionModel](#statusconnectionmodel)
- [StatusHostDisabled](#statushostdisabled)
- [StatusHostEnabled](#statushostenabled)
...
- [TagGroupIsNotOrIs](#taggroupisnotoris)
- [TagGroupIsNotOrIsOutput](#taggroupisnotorisoutput)
- [TagGroupNoneOfOrOneOfOutput](#taggroupnoneoforoneofoutput)
- [TagGroupNoneOfOrOneof](#taggroupnoneoforoneof)
- [TagGroupSelector](#taggroupselector)
- [TagGroupSelectorOutput](#taggroupselectoroutput)
- [TagTypeSelector](#tagtypeselector)
- [TagTypeSelectorOutput](#tagtypeselectoroutput)
- [TheFollowingUsers](#thefollowingusers)
- [ThrottlePeriodicNotifications](#throttleperiodicnotifications)
- [ThrottlePeriodicNotificationsCheckbox](#throttleperiodicnotificationscheckbox)
...
- [UpdateConfigurationEntity](#updateconfigurationentity)
...
- [UserDismissWarning](#userdismisswarning)
...
- [UserRoleExtensionsModel](#userroleextensionsmodel)
- [UserRoleModel](#userrolemodel)
- [UserSyncAllModel](#usersyncallmodel)
- [UserSyncDisabledModel](#usersyncdisabledmodel)
- [UserSyncWithLdapModel](#usersyncwithldapmodel)
- [ValidationMessage](#validationmessage)
- [ViaHostGroup](#viahostgroup)
- [ViaHostQuery](#viahostquery)
- [ViaServiceGroup](#viaservicegroup)
- [ViaServiceQuery](#viaservicequery)
- [ViaSpecificHost](#viaspecifichost)
- [ViaSpecificService](#viaspecificservice)
...
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select all hosts in a host group. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
| `hostgroup_name` | string | Yes | Host group name for which this acknowledgement is for. |
| `notify` | boolean | No | If set, notifications will be sent out to the configured contacts. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `sticky` | boolean | No | If set, only a state-change to the UP/OK state will discard the acknowledgeme... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select a specific host. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select hosts with a query. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
| `notify` | boolean | No | If set, notifications will be sent out to the configured contacts. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `query` | Expr | Yes | An query expression of the Livestatus 'hosts' table in nested dictionary form... |
| `sticky` | boolean | No | If set, only a state-change to the UP/OK state will discard the acknowledgeme... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select all services in a service group. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
| `notify` | boolean | No | If set, notifications will be sent out to the configured contacts. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select services with a query. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
| `notify` | boolean | No | If set, notifications will be sent out to the configured contacts. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `query` | Expr | Yes | An query expression of the Livestatus 'services' table in nested dictionary f... |
| `sticky` | boolean | No | If set, only a state-change to the UP/OK state will discard the acknowledgeme... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `acknowledge_type` | string | Yes | Select a specific service on a host. |
| `comment` | string | Yes | Comment to be stored alongside the acknowledgement. |
| `expire_on` | string | No | If set, the acknowledgement will expire at this time. The timezone will defau... |
| `host_name` | string | Yes | The name of the host. |
| `notify` | boolean | No | If set, notifications will be sent out to the configured contacts. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `service_description` | string | Yes | The acknowledgement process will be applied to all matching service names |
| `sticky` | boolean | No | If set, only a state-change to the UP/OK state will discard the acknowledgeme... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `button` | QuickSetupButton | No | Definition of the action button |
| `id` | string | No | The action id |
| `load_wait_label` | string | No | A string to display while waiting for the next stage |
...
| `force_foreign_changes` | boolean | No | A boolean flag indicating that even changes which do not originate from the u... |
| `is_running` | boolean | No | If the activation is still running |
| `sites` | []string | No | Sites affected by this activation |
| `time_started` | string | No | The date and time the activation started. |
...
| `is_running` | boolean | No | If the activation is still running |
| `sites` | []string | No | Sites affected by this activation |
| `status_per_site` | []ActivationSiteStatus | No | A list of sites with their activation status. |
| `time_started` | string | No | The date and time the activation started. |
...
| `value` | []ActivationStatusResponse | No | A list of activation runs. |
...
| `extensions` | ActivationExtensionFields | No | The activation run attributes. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `end_time` | string | No | The date and time the activation ended. |
| `phase` | string | No | The phase |
| `site` | string | No | The site affected by this activation |
| `start_time` | string | No | The date and time the activation started. |
| `state` | string | No | The state |
| `status_details` | string | No | The status details |
| `status_text` | string | No | The status text |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | ActivationExtensionStatusFields | No | The activation run attributes with status. |
| `id` | string | No | The unique identifier for this activation run. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | The activation run status. |
...
| `ext` | oneOf | No | Additional information about the error. |
| `fields` | object | No | Detailed error messages on all fields failing validation. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `body_head_for_both_host_and_service_notifications` | StrValueOneOf | No |  |
| `body_tail_for_host_notifications` | StrValueOneOf | No |  |
| `body_tail_for_service_notifications` | StrValueOneOf | No |  |
| `from_details` | FromDetailsOneOf | No |  |
| `plugin_name` | object | Yes | The ASCII Mail plug-in. |
| `reply_to` | ReplyToOneOf | No |  |
| `send_separate_notification_to_every_recipient` | Checkbox | No |  |
| `sort_order_for_bulk_notifications` | SortOrderOneOf | No |  |
| `subject_for_host_notifications` | SubjectHostOneOf | No |  |
| `subject_for_service_notifications` | SubjectServiceOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `extensions` | AuditLogExtension | No | Data and Meta-Data of this audit log entry. |
...
| `store_automation_secret` | boolean | No | If set to True, the secret is stored |
...
| `store_automation_secret` | boolean | No | If set to True, the secret will be stored unhashed in order to reuse it in ru... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `method` | string | No | The authentication method is fixed at 'plaintext' for now. |
| `password` | string | No | The password for the SMTP connection. |
| `user` | string | No | The username for the SMTP connection. |
...
| `tag_type` | object | No | Identifies the type of host tag. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | AuxTagAttrsResponse | No | The Auxiliary Tag attributes. |
...
| `downtime_only_on_full_problem_coverage` | boolean | No | Show downtime only when all current problems are covered |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `aggregation_visualization` | BIAggregationVisualization | Yes | Aggregation visualization options. |
| `comment` | string | No | An optional comment that may be used to explain the purpose of this object. |
| `computation_options` | BIAggregationComputationOptions | Yes | Computation options. |
| `customer` | string | No | [Only in editions: Ultimate with multi-tenancy] The customer id for this aggr... |
| `groups` | BIAggregationGroups | Yes | Groups. |
| `id` | string | Yes | The unique aggregation id |
| `node` | BINodeGenerator | Yes | Node generation. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `levels_ok` | BIAggregationFunctionCountSettings | Yes | Required number of OK child nodes for total state of OK. |
| `levels_warn` | BIAggregationFunctionCountSettings | Yes | Required number of OK child nodes for total state of WARN. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `params` | BIParams | Yes | Parameters for the rule. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | HostConditions | Yes | Host conditions. |
| `refer_to` | ReferTo | Yes | Create nodes based on the matched hosts, their parents or their children. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `action` | BIAction | Yes | Action on search results. |
| `search` | BISearch | Yes | Search criteria. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `style_config` | BINodeVisHierarchyStyleConfig | Yes | Configuration options for this style. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `style_config` | BINodeVisRadialStyleConfig | Yes | Configuration options for this style. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `aggregation_function` | BIAggregationFunction | Yes | Aggregation function. |
| `computation_options` | BIRuleComputationOptions | Yes | Computation options. |
| `id` | string | Yes | The unique rule id |
| `node_visualization` | BINodeVisLayoutStyle | Yes | Node visualization. |
| `nodes` | []BINodeGenerator | Yes | A list of nodes for for this rule |
| `pack_id` | string | Yes | The identifier of the BI pack. |
| `params` | BIParams | Yes | Parameters. |
| `properties` | BIRuleProperties | Yes | Rule properties. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | ServiceConditions | Yes | Service conditions. |
...
|----------|------|----------|-------------|
| `host_regex` | string | Yes | Host name regex. |
| `service_regex` | string | Yes | Service name regex. |
...
| `traceback` | string | No | The traceback of the exception |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `active` | boolean | Yes | This field indicates if the background job is running. |
| `site_id` | string | Yes | The site ID where the background job is located |
| `status` | BackgroundJobStatus | No | The status of the background job |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object |
| `extensions` | BackgroundJobSnapshot | No | The attributes of the background job |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `log_info` | StatusLogInfo | No | The logs of the background job |
| `state` | string | Yes | The state of the background job |
...
| `logs` | JobLogs | Yes | Logs related to the background job. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object |
| `extensions` | BackgroundJobStatus1 | No | The attributes of the background job |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth_option` | AuthOptionOutput | No | Enforce password change attribute for the user |
| `authorized_sites` | []string | No | The names of the sites that this user is authorized to handle |
| `contact_options` | ConcreteUserContactOption | No | Contact settings for the user |
| `contactgroups` | []string | No | The contact groups that this user is a member of |
| `customer` | string | No | [Only in editions: Ultimate with multi-tenancy] By specifying a customer, you... |
...
| `idle_timeout` | UserIdleOption | No | Idle timeout for the user. Per default, the global configuration is used. |
...
| `start_url` | string | No | The URL that the user should be redirected to after login. There is a 'defaul... |
...
| `customer` | string | No | [Only in editions: Ultimate with multi-tenancy] By specifying a customer, you... |
| `site_id` | string | Yes | The site ID for the new connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `bind_dn` | string | No | The distinguished name of the user account which is used to bind to the LDAP ... |
| `explicit_password` | string | Yes | An explicit password of the user account which is used to bind to the LDAP se... |
| `state` | object | Yes | This config parameter is enabled. |
| `type` | object | Yes |  |
...
|----------|------|----------|-------------|
| `bind_dn` | string | No | The distinguished name of the user account which is used to bind to the LDAP ... |
| `password_store_id` | string | Yes | A password store id from the user account which is used to bind to the LDAP s... |
| `state` | object | Yes | This config parameter is enabled. |
| `type` | object | Yes |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connectee` | SiteId | Yes | The ID of the site accepting the connection. |
| `connecter` | SiteId | Yes | The ID of the site initiating the connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connectee` | ConnectedSiteAttributes | No | The attributes of the site accepting the connection. |
| `connecter` | ConnectedSiteAttributes | No | The attributes of the site initiating the connection. |
| `id` | string | No | The unique identifier of the connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connection_config` | BrokerConnectionConfig | Yes | The connection configuration. |
| `connection_id` | string | Yes | An unique connection id for the broker connection |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | BrokerConnectionExtension | No | The configuration attributes of a broker peer to peer connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []BrokerConnectionResponse | No | A list of broker peer to peer configuration objects. |
...
| `options` | BulkDiscoveryOptions | Yes | The discovery options for the bulk discovery |
...
| `update_service_parameters` | boolean | No | The option whether to update discovered service parameters or not. |
...
|----------|------|----------|-------------|
| `detail` | string | No | Detailed information on what exactly went wrong. |
| `ext` | FailedHosts | No | Details for which hosts have failed |
| `fields` | object | No | Detailed error messages on all fields failing validation. |
| `status` | integer | No | The HTTP status code. |
| `title` | string | No | A summary of the problem. |
...
| `filter_type` | string | Yes | The way you would like to filter events. |
| `new_state` | string | Yes | The state |
| `query` | Expr | Yes | An query expression of the Livestatus 'eventconsoleevents' table in nested di... |
| `site_id` | string | No | An existing site id |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ManualOrAutomaticSelector | No | If you use Automatic HTTP/s, the URL prefix for host and service links within... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | MatchTypeSelector | Yes | The Event Console can have events create notifications in Check_MK. These not... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | HostEventType | No | Select the host event types and transitions this rule should handle. Note: If... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | HostEventTypeOutput | No | Select the host event types and transitions this rule should handle. Note: If... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | []TagTypeSelectorOutput | No | A list of tag groups or aux tags with conditions |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ServiceEventType | No | Select the service event types and transitions this rule should handle. Note:... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ServiceEventTypeOutput | No | Select the service event types and transitions this rule should handle. Note:... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | FromToServiceLevels | Yes | Host or service must be in the following service level to get notification |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | FromToServiceLevelsOutput | No | Host or service must be in the following service level to get notification |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ServiceGroupsRegex | Yes | The service group alias must not match one of the following regular expressio... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ServiceGroupsRegexOutput | No | The service group alias must not match one of the following regular expressio... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | HostConditions | Yes | Extra conditions for the child. |
| `host_choice` | BIHostChoice | Yes | Child host selector. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The Cisco plug-in. |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
| `bake_agent_package` | boolean | No | [Only in editions: all commercial editions] Bake agent packages for this fold... |
| `cmk_agent_connection` | string | No | [Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] This configu... |
| `contactgroups` | HostContactGroup | No | Only members of the contact groups listed here have Setup permission for the ... |
...
| `locked_by` | LockedBy | No | Identity of the entity which locked the locked_attributes. The identity is bu... |
| `management_address` | string | No | Address (IPv4, IPv6 or host name) under which the management board can be rea... |
| `management_ipmi_credentials` | oneOf | No | IPMI credentials |
| `management_protocol` | string | No | The protocol used to connect to the management board. Valid options are: * `n... |
| `management_snmp_community` | oneOf | No | SNMP credentials |
| `metrics_association` | object | No | [Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] Configuratio... |
| `network_scan` | NetworkScan | No | Configuration for automatic network scan. Pings will besent to each IP addres... |
| `parents` | []string | No | A list of parents of this host. |
| `relay` | string | No | [Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] The relay ID... |
| `site` | string | No | The site that should monitor this host. |
| `snmp_community` | SNMPCredentials | No | The SNMP access configuration. A configured SNMP v1/v2 community here will ha... |
| `tag_address_family` | string | No | The IP address family of the host. |
| `tag_agent` | string | No | Agent and API integrations |
| `tag_piggyback` | string | No | Use piggyback data for this host. |
| `tag_snmp_ds` | string | No | The SNMP data source of the host. |
| `waiting_for_discovery` | boolean | No | This indicates that the host is waiting for a bulk discovery. It is set to Tr... |
...
| `service_description` | string | No | The service name the comment belongs to. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | CommentAttributes | No | The attributes of a service/host comment. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `timerange` | DateTimeRange | No | A custom timerange during which notifications are disabled |
...
| `extensions` | HostTagExtensions | No | Additional fields for objects of this type. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `contextual_help_icon` | string | No | Whether or not to show the contextual icon in the UI for this user. |
| `interface_theme` | string | No | The theme of the interface |
| `main_menu_icons` | string | No | This option decides if colored icon should be shown foe every entry in the ma... |
| `mega_menu_icons` | string | No | Deprecated - use `main_menu_icons` instead. |
| `navbar_changes_action` | string | No | The view mode for activating changes. Either the slideout or the full page view. |
...
| `host_name` | HostOrServiceCondition | No | Here you can enter a list of explicit host names that the rule should or shou... |
| `host_tags` | []TagCondition | No | The rule will only be applied to hosts fulfilling all the host tag conditions... |
| `service_description` | HostOrServiceCondition | No | Specify a list of service patterns this rule shall apply to. * The patterns m... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `force_explicit_parents` | boolean | No | Force explicit setting for parents even if setting match that of the folder |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connection_mode` | string | No | [Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] This configu... |
...
| `is_trusted` | boolean | Yes | When this option is enabled the central site might get compromised by a rogue... |
| `message_broker_port` | integer | Yes | The port used by the message broker to exchange messages. |
...
| `user_sync` | oneOf | Yes | By default the users are synchronized automatically in the interval configure... |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | ContactGroupExtensions | No | All the attributes of the domain object. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `customer` | string | No | [Only in editions: Ultimate with multi-tenancy] The customer for which the ob... |
| `inventory_paths` | InventoryPaths | No | Permitted HW/SW Inventory paths. |
...
| `explicit_email_addresses` | ExplicitEmailAddressesCheckbox | No | Send notifications to the following explicit email addresses (non-CSE edition... |
| `members_of_contact_groups` | ListOfContactGroupsCheckbox | No |  |
| `restrict_by_contact_groups` | ListOfContactGroupsCheckbox | No |  |
| `restrict_by_custom_macros` | CustomMacrosCheckbox | No |  |
| `the_following_users` | TheFollowingUsers | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | ClusterCreateAttribute | No | Attributes to set on the newly created host. You can specify custom attribute... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `data` | object | Yes | The data of the configuration entity |
| `entity_type` | string | Yes | Type of configuration entity |
| `entity_type_specifier` | string | Yes | Specifier for the entity type |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | FolderCreateAttribute | No | Specific attributes to apply for all hosts in this folder (among other things... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | HostCreateAttribute | No | Attributes to set on the newly created host. You can specify custom attribute... |
| `folder` | string | Yes | The path name of the folder. Path delimiters can be either `~`, `/` or `\`. P... |
...
|----------|------|----------|-------------|
| `comment` | string | No |  |
| `downtime_type` | string | Yes | The type of downtime to create. Valid options are: * `host` - Schedule downti... |
...
| `comment_type` | string | Yes | How you would like to leave a comment. |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `query` | Expr | No | An query expression of the Livestatus 'hosts' table in nested dictionary form... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `folder` | string | Yes | Folder location where the gateway hosts should be created Path delimiters can... |
| `hosts_alias` | string | No | Alias for created gateway hosts |
| `option` | string | Yes | Creation of gateway hosts option |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `option` | object | No | Create notifications with parameters |
...
| `editable_by` | string | No | Each password is owned by a group of users which are able to edit, delete and... |
| `ident` | string | Yes | The unique identifier for the password |
| `owner` | string | No | Deprecated - use `editable_by` instead. Each password is owned by a group of ... |
...
| `host_name` | string | Yes | The host name |
| `persistent` | boolean | No | If set, the comment will persist a restart. |
| `service_description` | string | Yes | The service name for which the comment is for. No exception is raised when th... |
...
|----------|------|----------|-------------|
| `comment` | string | No |  |
| `downtime_type` | string | Yes | The type of downtime to create. Valid options are: * `service` - Schedule dow... |
| `duration` | integer | No | Duration in minutes. When set, the downtime does not begin automatically at a... |
| `end_time` | string | Yes | The end datetime of the new downtime. The format has to conform to the ISO 86... |
| `host_name` | string | Yes |  |
| `recur` | string | No | The recurring mode of the new downtime. Available modes are: * fixed * hour *... |
| `service_descriptions` | []string | Yes | The service name of the service, whose problems shall be acknowledged. |
| `start_time` | string | Yes | The start datetime of the new downtime. The format has to conform to the ISO ... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth_option` | AuthOption | No | Authentication option for the user |
| `authorized_sites` | []string | No | The names of the sites the user is authorized to handle. |
| `contact_options` | UserContactOption | No | Contact settings for the user |
...
| `disable_notifications` | DisabledNotifications | No |  |
| `fullname` | string | Yes | The alias or full name of the user |
| `idle_timeout` | IdleOption | No | Idle timeout for the user. Per default, the global configuration is used. |
| `interface_options` | UserInterfaceAttributes | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `enforce_two_factor_authentication` | boolean | No | If enabled, all users with this role will be required to setup two factor aut... |
...
| `role_id` | string | Yes | An existing userrole that you want to clone. |
...
|----------|------|----------|-------------|
| `delete_type` | string | Yes | How you would like to delete comments. |
| `query` | Expr | No | An query expression of the Livestatus 'comments' table in nested dictionary f... |
...
| `hostgroup_name` | string | Yes | Name of a valid hostgroup, all current downtimes for hosts in this group will... |
...
|----------|------|----------|-------------|
| `delete_type` | string | Yes | The option how to delete a downtime. |
| `query` | Expr | Yes | An query expression of the Livestatus 'downtimes' table in nested dictionary ... |
...
|----------|------|----------|-------------|
| `delete_type` | string | Yes | The option how to delete a downtime. |
| `servicegroup_name` | string | Yes | Name of a valid servicegroup, all current downtimes for services in this grou... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `use_livestatus_daemon` | string | Yes | Use livestatus daemon with direct connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `domain` | string | Yes | Configure the DNS domain name of your Active directory domain here, Checkmk w... |
| `type` | string | Yes | Select the software the LDAP directory is based on. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `failover_servers` | []string | No | When the connection to the first server fails with connect specific errors li... |
| `ldap_server` | string | Yes | Set the host address of the LDAP server. Might be an IP address or resolvable... |
| `type` | string | Yes | Select the software the LDAP directory is based on. |
...
|----------|------|----------|-------------|
| `disable` | boolean | No | Option if all notifications should be temporarily disabled |
| `timerange` | DisableNotificationCustomTimeRange | No | A custom timerange during which notifications are disabled |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | DowntimeAttributes | No | The attributes of a downtime. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | ECEventAttributes | No | The configuration attributes of a site. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `domainType` | object | No | Domain type of the configuration entity |
| `extensions` | ResponseData | No | Response data for entity creation |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
|----------|------|----------|-------------|
| `auth` | AuthOneOf | No |  |
| `encryption` | string | No | The encryption type for the SMTP connection. |
| `port` | integer | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `formspec_errors` | object | No | A mapping of formspec ids to formspec validation errors |
| `stage_errors` | []string | No | A collection of general stage errors |
| `stage_index` | integer | No | Index of the stage containing errors. |
...
|----------|------|----------|-------------|
| `option` | string | Yes |  |
| `token` | string | Yes | Your personal access token |
...
| `succeeded_hosts` | HostConfigCollection | No | The list of succeeded host objects |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | Yes | The downtime is fixed to the start and end time. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `duration_minutes` | integer | Yes | The flexible duration in minutes. |
| `type` | object | Yes | The downtime starts if the host or service goes down during the specified sta... |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | FolderExtensions | No | Data and Meta-Data of this object. |
| `id` | string | No | The full path of the folder, tilde-separated. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | FolderMembers | No | Specific collections or actions applicable to this object. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | FolderViewAttribute | No | The folder's attributes. Hosts placed in this folder will inherit these attri... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `hosts` | ObjectCollectionMember | No | A list of links pointing to the actual host-resources. |
| `move` | ObjectActionMember | No | An action which triggers the move of this folder to another folder. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []FolderResponse | No | A list of folder objects. |
...
| `management_protocol` | string | No | The protocol used to connect to the management board. Valid options are: * `n... |
| `management_snmp_community` | oneOf | No | SNMP credentials |
| `meta_data` | MetaData | No | Read only access to configured metadata. |
| `network_scan` | NetworkScan | No | Configuration for automatic network scan. Pings will besent to each IP addres... |
| `network_scan_result` | NetworkScanResult | No | Read only access to the network scan result |
| `parents` | []string | No | A list of parents of this host. |
| `site` | string | No | The site that should monitor this host. |
| `snmp_community` | SNMPCredentials | No | The SNMP access configuration. A configured SNMP v1/v2 community here will ha... |
| `tag_address_family` | string | No | The IP address family of the host. |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | EmailAndDisplayName | No | The email address and visible name used in the From header of notifications m... |
...
| `time_range` | TimeRange | Yes | The time range from which to source the metrics. |
...
| `time_range` | TimeRange | Yes | The time range within the samples of the response lie. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `bulk_notifications_with_graphs` | BulkNotificationsOneOf | No |  |
| `display_graphs_among_each_other` | Checkbox | No |  |
| `enable_sync_smtp` | EnableSyncOneOf | No |  |
| `from_details` | FromDetailsOneOf | No |  |
| `graphs_per_notification` | GraphsPerNotificationOneOf | No |  |
| `info_to_be_displayed_in_the_email_body` | EmailInfoOneOf | No |  |
| `insert_html_section_between_body_and_table` | InsertHtmlOneOf | No |  |
| `plugin_name` | object | Yes | The HTML mail plug-in. |
| `reply_to` | ReplyToOneOf | No |  |
| `send_separate_notification_to_every_recipient` | Checkbox | No |  |
| `sort_order_for_bulk_notifications` | SortOrderOneOf | No |  |
| `subject_for_host_notifications` | SubjectHostOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `host_choice` | BIHostChoice | Yes | Host selection. |
| `host_folder` | string | Yes | Host folder. |
| `host_label_groups` | []LabelGroupCondition | Yes | Host label conditions. Although all items in this list have a default operato... |
...
|----------|------|----------|-------------|
| `domainType` | object | Yes | The domain type of the object. |
| `extensions` | HostExtensions | No | All the data and metadata of this host. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | HostMembers | No | All the members of the host object. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `mode` | DowntimeMode | Yes | The mode of the downtime, either fixed or flexible. |
| `recurring` | boolean | Yes | Indicates if this downtime is time-repetitive |
| `site_id` | string | Yes | The site id of the downtime. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | HostViewAttribute | No | Attributes of this host. |
| `cluster_nodes` | []string | No | In the case this is a cluster host, these are the cluster nodes. |
| `effective_attributes` | oneOf | No | All attributes of this host and all parent folders. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | HostGroupExtensions | No | All the attributes of the domain object. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `folder_config` | Folder | No | The folder in which this host resides. It is represented by a hexadecimal ide... |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | HttpProxyOptions | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
...
| `host` | string | Yes | The IP4 address or domain name of the host. |
| `port` | integer | Yes | The TCP port to connect to. |
| `socket_type` | string | Yes | The tcp socket type |
...
|----------|------|----------|-------------|
| `encrypted` | boolean | Yes | To enable an encrypted connection. |
| `host` | string | Yes | The IP6 address or domain name of the host. |
| `port` | integer | Yes | The TCP port to connect to. |
| `socket_type` | string | Yes | The tcp6 socket type |
| `verify` | boolean | No | Verify server certificate. |
...
| `plugin_name` | object | Yes | The Ilert plug-in. |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `caller` | string | No | Caller is the user on behalf of whom the incident is being reported within Se... |
| `host_description` | StrValueOneOf | No |  |
| `host_short_description` | StrValueOneOf | No |  |
...
|----------|------|----------|-------------|
| `host_label_groups` | []LabelGroupCondition1 | No | Further restrict this rule by applying host label conditions. Although all it... |
| `host_labels` | []LabelCondition2 | No | Further restrict this rule by applying host label conditions. - Deprecated: U... |
| `host_name` | HostOrServiceCondition | No | Here you can enter a list of explicit host names that the rule should or shou... |
| `host_tags` | []TagCondition | No | The rule will only be applied to hosts fulfilling all the host tag conditions... |
| `service_description` | HostOrServiceCondition | No | Specify a list of service patterns this rule shall apply to. * The patterns m... |
| `service_label_groups` | []LabelGroupCondition1 | No | Restrict the application of the rule, by checking against service label condi... |
| `service_labels` | []LabelCondition2 | No | Restrict the application of the rule, by checking against service label condi... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | InputConditions | No | Conditions. |
| `folder` | string | Yes | The path name of the folder. Path delimiters can be either `~`, `/` or `\`. P... |
| `properties` | Properties | No | Configuration values for rules. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | No | Allowed to see the whole tree. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | No | Forbidden to see the whole tree. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | PathRestriction | No | Restrict single values. |
| `columns` | PathRestriction | No | Restrict table columns. |
| `nodes` | PathRestriction | No | Restrict subcategories. |
| `path` | string | Yes | Path to category. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `paths` | []InventoryPathSpecificPath | Yes | A list of paths to be allowed. |
| `type` | object | No | Allowed to see parts of the tree. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth` | AuthSelector | Yes | The authentication credentials for the Jira connection |
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `graphs_per_notification` | GraphsPerNotificationOneOf | No | Here you can set a limit for the number of graphs that are displayed in a not... |
| `host_custom_id` | string | Yes | The numerical Jira custom field ID for host problems |
| `host_summary` | StrValueOneOf | No | Here you are allowed to use all macros that are defined in the notification c... |
| `issue_type_id` | string | No | The numerical Jira issue type ID. If not set, it will be retrieved from a cus... |
| `jira_url` | string | No | Configure the Jira URL here |
| `label` | StrValueOneOf | No | Here you can set a custom label for new issues. If not set, 'monitoring' will... |
| `monitoring_url` | string | Yes | Configure the base URL for the monitoring web GUI here. Include the site name... |
| `optional_timeout` | StrValueOneOf | No | Here you can configure timeout settings. |
| `plugin_name` | object | Yes | The Jira plug-in. |
| `priority_id` | StrValueOneOf | No | The numerical Jira priority ID. If not set, it will be retrieved from a custo... |
| `project_id` | string | No | The numerical Jira project ID. If not set, it will be retrieved from a custom... |
| `resolution_id` | StrValueOneOf | No | The numerical Jira resolution transition ID. 11 - 'To Do', 21 - 'In Progress'... |
| `service_custom_id` | string | Yes | The numerical Jira custom field ID for service problems |
| `service_summary` | StrValueOneOf | No | Here you are allowed to use all macros that are defined in the notification c... |
| `site_custom_id` | StrValueOneOf | No | The numerical ID of the Jira custom field for sites. Please use this option i... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | ListOfStrOneOf | No | Custom actions that will be available for the alert. |
| `additional_responders` | ListOfTypedRespondersOneOf | No | Additional non-team responders (user, on-call schedule, escalation policy) to... |
| `api_key` | OpsGenisStoreOrExplicitKeySelector | Yes |  |
| `desc_for_host_alerts` | StrValueOneOf | No | Description field of host alert that is generally used to provide a detailed ... |
| `desc_for_service_alerts` | StrValueOneOf | No | Description field of service alert that is generally used to provide a detail... |
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `entity` | StrValueOneOf | No | Is used to specify which domain the alert is related to |
| `extra_properties` | ListOfExtraPropertiesOneOf | No | A list of extra properties that will be included in the notification |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `message_for_host_alerts` | StrValueOneOf | No |  |
| `message_for_service_alerts` | StrValueOneOf | No |  |
| `note_while_closing` | StrValueOneOf | No | Additional note that will be added while closing the alert |
| `note_while_creating` | StrValueOneOf | No | Additional note that will be added while creating the alert |
| `owner` | StrValueOneOf | No | Sets the assignee of the alert. Display name of an existing JSM user |
| `plugin_name` | object | Yes | The Jira Service Management Operations plug-in. |
| `priority` | OpsGeniePriorityOneOf | No |  |
| `responsible_teams` | ListOfStrOneOf | No | Team names that will be added as responders for the alert. The integration's ... |
| `source` | StrValueOneOf | No | Source field of the alert. Default value is IP address of the incoming request |
| `tags` | ListOfStrOneOf | No | Tags of the alert. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `name` | string | Yes | Identifier of the responder. For ``user`` this is the username (typically the... |
| `type` | string | Yes | JSM Operations responder type. ``user`` adds an individual responder, ``sched... |
...
|----------|------|----------|-------------|
| `bind_dn` | string | No | The distinguished name of the user account which is used to bind to the LDAP ... |
| `explicit_password` | string | No | An explicit password of the user account which is used to bind to the LDAP se... |
| `password_store_id` | string | No | A password store id from the user account which is used to bind to the LDAP s... |
| `state` | string | No |  |
| `type` | string | No | A specific password or a password store id |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `from_time` | string | Yes | The start of the time range |
| `state` | object | Yes | This config parameter is enabled. |
| `to_time` | string | Yes | The end of the time range |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `state` | object | No | This config parameter is disabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `seconds` | number | No | Timeout for the initial connection to the LDAP server in seconds. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `bind_credentials` | LDAPBindCredentials | No | The credentials used to connect to the LDAP server. |
| `connect_timeout` | LDAPConnectTimeout | No | If the connection timeout is set and its value. |
| `connection_suffix` | LDAPConnectionSuffix | No | If the connection suffix is enabled and what its set to. |
| `directory_type` | LDAPDirectoryTypeConnection | No | The credentials to be used to connect to the LDAP server. The used account mu... |
| `ldap_version` | LDAPVersion | No | If the ldap version is set and the version it's set to. Either 2 or 3. |
| `page_size` | LDAPPageSize | No | If the page size is enabled and its value. |
| `response_timeout` | LDAPResponseTimeout | No | Enable the response timeout and define its value. |
| `ssl_encryption` | string | No | Connect to the LDAP server with a SSL encrypted connection. The trusted certi... |
| `tcp_port` | LDAPTCPPort | No | The TCP port to be used to connect to the LDAP server. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `general_properties` | LDAPGeneralProperties | No |  |
| `groups` | LDAPGroups | No |  |
| `ldap_connection` | LDAPConnection | No |  |
| `other` | LDAPOther | No |  |
| `sync_plugins` | LDAPSyncPlugins | No |  |
| `users` | LDAPUsers | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `general_properties` | LDAPGeneralPropertiesCreateRequest | Yes | General properties of an LDAP connection. |
| `groups` | LDAPGroupsRequest | No | The LDAP group configuration |
| `ldap_connection` | LDAPConnectionCreateRequest | Yes | The LDAP connection configuration |
| `other` | LDAPOtherRequest | No | Other config options for the LDAP connection. |
| `sync_plugins` | LDAPSyncPluginsRequest | No | The LDAP sync plug-ins configuration |
| `users` | LDAPUsersRequest | No | The LDAP user configuration |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `general_properties` | LDAPGeneralPropertiesUpdateRequest | Yes | General properties of an LDAP connection. |
| `groups` | LDAPGroupsRequest | No | The LDAP group configuration |
| `ldap_connection` | LDAPConnectionUpdateRequest | Yes | The LDAP connection configuration |
| `other` | LDAPOtherRequest | No | Other config options for the LDAP connection. |
| `sync_plugins` | LDAPSyncPluginsRequest | No | The LDAP sync plug-ins configuration |
| `users` | LDAPUsersRequest | No | The LDAP user configuration |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `bind_credentials` | BindCredentialsSelectorRequest | No | The credentials used to connect to the LDAP server. |
| `connect_timeout` | LDAPConnectTimeoutSelectorRequest | No | If the connection timeout is set and its value. |
| `connection_suffix` | LDAPConnectionSuffixCreateSelectorRequest | No | If the connection suffix is enabled and what its set to. |
| `directory_type` | DirectoryTypeSelectorRequest | Yes | The credentials to be used to connect to the LDAP server. The used account mu... |
| `ldap_version` | LDAPVersionSelectorRequest | No | If the ldap version is set and the version it's set to. |
| `page_size` | LDAPPageSizeSelectorRequest | No | If the page size is enabled and its value. |
| `response_timeout` | LDAPResponseTimeoutSelectorRequest | No | Enable the response timeout and define its value. |
| `ssl_encryption` | string | No | Connect to the LDAP server with a SSL encrypted connection. The trusted certi... |
| `tcp_port` | LDAPTCPPortSelectorRequest | No | The TCP port to be used to connect to the LDAP server. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | LDAPConnectionConfig | No | The configuration attributes of a user LDAP connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []LDAPConnectionResponse | No | A list of LDAP connections. |
...
|----------|------|----------|-------------|
| `state` | string | No |  |
| `suffix` | string | No | The LDAP connection suffix can be used to distinguish equal named objects (na... |
...
|----------|------|----------|-------------|
| `state` | object | Yes | This config parameter is enabled. |
| `suffix` | string | Yes | The LDAP connection suffix can be used to distinguish equal named objects (na... |
...
| `bind_credentials` | BindCredentialsSelectorRequest | No | The credentials used to connect to the LDAP server. |
| `connect_timeout` | LDAPConnectTimeoutSelectorRequest | No | If the connection timeout is set and its value. |
| `connection_suffix` | LDAPConnectionSuffixUpdateSelectorRequest | No | If the connection suffix is enabled and what its set to. |
| `directory_type` | DirectoryTypeSelectorRequest | Yes | The credentials to be used to connect to the LDAP server. The used account mu... |
| `ldap_version` | LDAPVersionSelectorRequest | No | If the ldap version is set and the version it's set to. |
| `page_size` | LDAPPageSizeSelectorRequest | No | If the page size is enabled and its value. |
| `response_timeout` | LDAPResponseTimeoutSelectorRequest | No | Enable the response timeout and define its value. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `handle_nested` | boolean | No | When enabled, this plug-in will not only handle direct group memberships, ins... |
| `state` | string | No |  |
| `sync_from_other_connections` | []string | No | This is a special feature for environments where user accounts are located in... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `domain` | string | No | Configure the DNS domain name of your Active directory domain here, Checkmk w... |
| `failover_servers` | []string | No | When the connection to the first server fails with connect specific errors li... |
| `ldap_server` | string | No | Set the host address of the LDAP server. Might be an IP address or resolvable... |
| `type` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `custom_time_range` | LDAPFromToFields | No | Here you can specify a time range where no notifications are generated. |
| `temporarily_disable_all_notifications` | boolean | No | When this option is active you will not get any alerts or other notifications... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `admin` | []LDAPRoleElementRequest | No |  |
| `agent_registration` | []LDAPRoleElementRequest | No |  |
| `guest` | []LDAPRoleElementRequest | No |  |
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `state` | object | Yes | This config parameter is enabled. |
| `user` | []LDAPRoleElementRequest | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `comment` | string | No | An optional comment to explain the purpose of this object. The comment is onl... |
| `description` | string | No | Add a title or describe this rule |
| `documentation_url` | string | No | An optional URL linking documentation or any other page. An icon links to the... |
| `id` | string | No | The LDAP connection ID. |
| `rule_activation` | string | No | Selecting 'deactivated' will disable the rule, but it will remain in the conf... |
...
| `description` | string | No | Add a title or describe this rule |
| `documentation_url` | string | No | An optional URL linking documentation or any other page. An icon links to the... |
| `id` | string | Yes | An LDAP connection ID string. |
| `rule_activation` | string | No | Selecting 'deactivated' will disable the rule, but it will remain in the conf... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | No | Define an optional LDAP filter which is used during group related LDAP search... |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | Yes | Define an optional LDAP filter which is used during group related LDAP search... |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `group_base_dn` | string | No | Give a base distinguished name here. All groups used must be located below th... |
| `member_attribute` | LDAPMemberAttributeValue | No | Enable and define a member attribute. |
| `search_filter` | LDAPGroupSearchFilter | No | Enable and define an optional LDAP filter. |
| `search_scope` | string | No | Scope to be used in group related LDAP searches. In most cases Search whole s... |
...
|----------|------|----------|-------------|
| `group_base_dn` | string | No | Give a base distinguished name here. All groups used must be located below th... |
| `member_attribute` | LDAPMemberAttributeSelector | No | Enable and define a member attribute. |
| `search_filter` | LDAPGroupSearchFilterSelector | No | Enable and define an optional LDAP filter. |
| `search_scope` | string | No | Scope to be used in group related LDAP searches. In most cases Search whole s... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `groups_to_sync` | []LDAPGroupsToSyncSelector | No | Specify the groups to control the value of a given user attribute. If a user ... |
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `state` | string | No |  |
| `sync_from_other_connections` | []string | No | This is a special feature for environments where user accounts are located in... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `admin` | []LDAPRoleElement | No |  |
| `agent_registration` | []LDAPRoleElement | No |  |
| `guest` | []LDAPRoleElement | No |  |
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `state` | string | No |  |
| `user` | []LDAPRoleElement | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_set` | string | No | The name of the attribute to set. |
| `group_cn` | string | No | The common name of the group in LDAP. This is the name of the group as it is ... |
| `value` | LDAPDisableNotificationsValue | No | The value of the attribute to set |
...
| `attribute_to_set` | string | No | The name of the attribute to set. |
| `group_cn` | string | No | The common name of the group in LDAP. This is the name of the group as it is ... |
| `value` | string | No | The URL that the user should be redirected to after login. There is a 'defaul... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | Yes | The attribute used to identify users group memberships. |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | No | The attribute used to identify users group memberships. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sync_interval` | LDAPSyncInterval | No | This option defines the interval of the LDAP synchronization. This setting is... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sync_interval` | LDAPSyncIntervalRequest | No | This option defines the interval of the LDAP synchronization. This setting is... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `size` | integer | No | LDAP searches can be performed in paginated mode, for example to improve the ... |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `seconds` | integer | No | Timeout for the initial connection to the LDAP server in seconds. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `group_dn` | string | No | This group must be defined within the scope of the LDAP Group Settings |
| `search_in` | string | No | An existing ldap connection. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `group_dn` | string | Yes | This group must be defined within the scope of the LDAP Group Settings |
| `search_in` | string | No | An existing ldap connection. Use 'this_connection' to select the current conn... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `days` | integer | No | The sync interval in days |
| `hours` | integer | No | The sync interval in hours |
| `minutes` | integer | No | The sync interval in minutes |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | No | The LDAP attribute containing the alias of the user. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | Yes | The attribute to sync |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | No | When the value of this attribute changes for a user account, all current auth... |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | No | The LDAP attribute whose contents shall be synced into this custom attribute. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | No | The LDAP attribute containing the mail address of the user. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_set` | string | Yes | The attribute to set |
| `group_cn` | string | Yes | The common name of the group |
| `value` | string | Yes |  |
...
| `attribute_to_set` | string | Yes | The attribute to set |
| `group_cn` | string | Yes | The common name of the group |
| `value` | LDAPSyncPluginGroupsValueRequest | Yes | The value to set |
...
| `attribute_to_set` | string | Yes | The attribute to set |
| `group_cn` | string | Yes | The common name of the group |
| `value` | string | Yes | The URL that the user should be redirected to after login. There is a 'defaul... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `groups_to_sync` | []LDAPSyncPluginGroupsToSyncSelector | No |  |
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `state` | object | Yes | This config parameter is enabled. |
| `sync_from_other_connections` | []string | No | The LDAP attribute whose contents shall be synced into this custom attribute. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `custom_time_range` | LDAPCustomTimeRangeSelector | Yes |  |
| `temporarily_disable_all_notifications` | boolean | No | When this option is active you will not get any alerts or other notifications... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_to_sync` | string | No | The LDAP attribute containing the pager number of the user. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `alias` | LDAPSyncPluginAlias | No | Populates the alias attribute of the Setup user by synchronizing an attribute... |
| `authentication_expiration` | LDAPSyncPluginAuthExp | No | This plug-in fetches all information which are needed to check whether or not... |
| `contact_group_membership` | LDAPContactGroupMembership | No | Adds the user to contact groups based on the group memberships in LDAP. This ... |
| `disable_notifications` | LDAPSyncPluginDisableNotifications | No | When this option is active you will not get any alerts or other notifications... |
| `email_address` | LDAPSyncPluginEmailAddress | No | Synchronizes the email of the LDAP user account into Checkmk |
| `groups_to_custom_user_attributes` | LDAPGroupsToAttributes | No | Sets custom user attributes based on the group memberships in LDAP. This plug... |
| `groups_to_roles` | LDAPGroupsToRoles | No | Configures the roles of the user depending on its group memberships in LDAP. |
| `main_menu_icons` | LDAPSyncPluginMenuIcons | No | In the main menus you can select between two options: Have a green icon only ... |
| `mega_menu_icons` | LDAPSyncPluginMenuIcons | No | Deprecated - use `main_menu_icons` instead. |
| `navigation_bar_icons` | LDAPSyncPluginNavBarIcons | No | With this option you can define if icons in the navigation bar should show a ... |
| `pager` | LDAPSyncPluginPager | No | This plug-in synchronizes a field of the users LDAP account to the pager attr... |
| `show_mode` | LDAPSyncPluginShowMode | No | In some places like e.g. the main menu Checkmk divides features, filters, inp... |
| `start_url` | LDAPSyncPluginStartURL | No | The start URL to display in main frame. |
| `temperature_unit` | LDAPSyncPluginTempUnit | No | Set the temperature unit used for graphs and perfometers. The default unit ca... |
| `ui_sidebar_position` | LDAPSyncPluginSideBarPosition | No | The sidebar position |
| `ui_theme` | LDAPSyncPluginUITheme | No | The user interface theme |
| `visibility_of_hosts_or_services` | LDAPSyncPluginVisibilityOfHostsOrServices | No | When this option is checked, the status GUI will only display hosts and servi... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `alias` | LDAPSyncPluginAttrubuteSelector | No | Enables and populates the alias attribute of the Setup user by synchronizing ... |
| `authentication_expiration` | LDAPSyncPluginAttrubuteSelector | No | This plug-in when enabled fetches all information which is needed to check wh... |
| `contact_group_membership` | LDAPSyncPluginGroupsToContactGroupsSelector | No | This plug-in allows you to synchronize group memberships of the LDAP user acc... |
| `disable_notifications` | LDAPSyncPluginAttrubuteSelector | No | When this option is enabled you will not get any alerts or other notification... |
| `email_address` | LDAPSyncPluginAttrubuteSelector | No | Synchronizes the email of the LDAP user account into Checkmk when enabled |
| `groups_to_custom_user_attributes` | LDAPSyncPluginGroupsToAttributesSelector | No | This plug-in allows you to synchronize group memberships of the LDAP user acc... |
| `groups_to_roles` | LDAPGroupsToRolesSelector | No | Configures the roles of the user depending on its group memberships in LDAP. ... |
| `main_menu_icons` | LDAPSyncPluginAttrubuteSelector | No | When enabled, in the main menus you can select between two options: Have a gr... |
| `mega_menu_icons` | LDAPSyncPluginAttrubuteSelector | No | Deprecated - use `main_menu_icons` instead. |
| `navigation_bar_icons` | LDAPSyncPluginAttrubuteSelector | No | With this option enabled you can define if icons in the navigation bar should... |
| `pager` | LDAPSyncPluginAttrubuteSelector | No | When enabled, this plug-in synchronizes a field of the users LDAP account to ... |
| `show_mode` | LDAPSyncPluginAttrubuteSelector | No | In some places like e.g. the main menu Checkmk divides features, filters, inp... |
| `start_url` | LDAPSyncPluginAttrubuteSelector | No | The start URL to display in main frame. |
| `temperature_unit` | LDAPSyncPluginAttrubuteSelector | No | Set the temperature unit used for graphs and perfometers. The default unit ca... |
| `ui_sidebar_position` | LDAPSyncPluginAttrubuteSelector | No | The sidebar position |
| `ui_theme` | LDAPSyncPluginAttrubuteSelector | No | The user interface theme |
| `visibility_of_hosts_or_services` | LDAPSyncPluginAttrubuteSelector | No | When this option is checked, the status GUI will only display hosts and servi... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `port` | integer | No | This variable allows you to specify the TCP port to be used to connect to the... |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | No | Define the DN of a group object which is used to filter the users. |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | Yes | Define the DN of a group object which is used to filter the users. |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | No | The attribute used to identify the individual users. It must have unique valu... |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | Yes | The attribute used to identify the individual users. It must have unique valu... |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | No | Using this option you can define an optional LDAP filter which is used during... |
| `state` | string | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `filter` | string | Yes | Using this option you can define an optional LDAP filter which is used during... |
| `state` | object | Yes | This config parameter is enabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `create_users` | string | No | Create user accounts during sync or on the first login |
| `filter_group` | LDAPUserGroupFilter | No | Enable and define the DN of a group object which is used to filter the users. |
| `search_filter` | LDAPUserSearchFilter | No | Enable and define an optional LDAP filter. |
| `search_scope` | string | No | Scope to be used in LDAP searches. In most cases Search whole subtree below t... |
| `umlauts_in_user_ids` | string | No | Checkmk does not support special characters in User-IDs. However, to deal wit... |
| `user_base_dn` | string | No | Give a base distinguished name here. All user accounts to synchronize must be... |
| `user_id_attribute` | LDAPUserIDAttribute | No | Enable and define a user ID attribute. |
| `user_id_case` | string | No | Convert imported User-IDs to lower case during synchronization or leave as is. |
...
|----------|------|----------|-------------|
| `create_users` | string | No | Create user accounts during sync or on the first login |
| `filter_group` | LDAPUserGroupFilterRequestSelector | No | Enable and define the DN of a group object which is used to filter the users. |
| `search_filter` | LDAPUserSearchFilterRequestSelector | No | Enable and define an optional LDAP filter. |
| `search_scope` | string | No | Scope to be used in LDAP searches. In most cases Search whole subtree below t... |
| `umlauts_in_user_ids` | string | No | Checkmk does not support special characters in User-IDs. However, to deal wit... |
| `user_base_dn` | string | No | Give a base distinguished name here. All user accounts to synchronize must be... |
| `user_id_attribute` | LDAPUserIDAttributeRequestSelector | No | Enable and define a user ID attribute. |
| `user_id_case` | string | No | Convert imported User-IDs to lower case during synchronization or leave as is. |
...
|----------|------|----------|-------------|
| `state` | string | No |  |
| `version` | integer | No | The selected LDAP version the LDAP server is serving. Most modern servers use... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `label_group` | []LabelCondition1 | Yes | A list of label conditions that form a label group |
...
| `method` | string | Yes | The HTTP method to use to traverse the link (get, post, put, delete or patch) |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `body_params` | object | No | A map of values that shall be sent in the request body. If this is present, t... |
| `domainType` | string | Yes | The domain type of the linked resource |
| `href` | string | Yes | The (absolute) address of the related resource. Any characters that are inval... |
| `method` | string | Yes | The HTTP method to use to traverse the link (get, post, put, delete or patch) |
| `rel` | string | Yes | Indicates the nature of the relationship of the related resource to the resou... |
| `title` | string | No | string that the consuming application may use to render the link without havi... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `socket_type` | string | Yes | The local socket type |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `affected_host_groups` | Checkbox | No | Enable/disable if we show affected host groups in the created message |
| `host_details` | StrValueOneOf | No | Enable/disable the details for host notifications |
| `host_summary` | StrValueOneOf | No | Enable/disable the summary for host notifications |
| `host_title` | StrValueOneOf | No | Enable/disable the title for host notifications |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The MicrosoftTeams plug-in. |
| `service_details` | StrValueOneOf | No | Enable/disable the details for service notifications |
| `service_summary` | StrValueOneOf | No | Enable/disable the summary for service notifications |
| `service_title` | StrValueOneOf | No | Enable/disable the title for service notifications |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `ip_address_of_remote_event_console` | IPAddressOneOf | No |  |
| `plugin_name` | object | Yes | The MkEventd plug-in. |
| `syslog_facility_to_use` | SysLogFacilityOneOf | No |  |
...
| `end_time` | ModifyEndTimeType | No | The option how to modify the end time of a downtime. If modify_type is set to... |
| `hostgroup_name` | string | Yes | Name of a valid hostgroup, all current downtimes for hosts in this group will... |
...
| `position` | string | No | The type of position to move to. Note that you cannot move rules before rules... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | No | No restriction on the path. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `expr` | Expr | No | The query expression to negate. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []NotificationParamResponse | No | A list of notification parameter objects. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `rule_config` | RuleNotification | Yes |  |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | NotificationRuleConfig | No | The configuration attributes of a notification rule. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []Oauth2ConnectionResponse | No | A list of OAuth2 configuration entities. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | ListOfStrOneOf | No | Custom actions that will be available for the alert. You may paste a text fro... |
| `api_key` | OpsGenisStoreOrExplicitKeySelector | Yes |  |
| `desc_for_host_alerts` | StrValueOneOf | No | Description field of host alert that is generally used to provide a detailed ... |
| `desc_for_service_alerts` | StrValueOneOf | No | Description field of service alert that is generally used to provide a detail... |
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `domain` | StrValueOneOf | No | If you have an european account, please set the domain of your opsgenie. Spec... |
| `entity` | StrValueOneOf | No | Is used to specify which domain the alert is related to |
| `extra_properties` | ListOfExtraPropertiesOneOf | No | A list of extra properties that will be included in the notification |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `message_for_host_alerts` | StrValueOneOf | No |  |
...
| `note_while_closing` | StrValueOneOf | No | Additional note that will be added while closing the alert |
| `note_while_creating` | StrValueOneOf | No | Additional note that will be added while creating the alert |
| `owner` | StrValueOneOf | No | Sets the user of the alert. Display name of the request owner |
| `plugin_name` | object | Yes | The OpsGenie plug-in. |
| `priority` | OpsGeniePriorityOneOf | No |  |
| `responsible_teams` | ListOfStrOneOf | No | Team names which will be responsible for the alert. If the API Key belongs to... |
| `source` | StrValueOneOf | No | Source field of the alert. Default value is IP address of the incoming request |
| `tags` | ListOfStrOneOf | No | Tags of the alert. You may paste a text from your clipboard which contains se... |
...
| `plugin_name` | object | Yes | The PagerDuty plug-in. |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `configuration` | Configuration | Yes | Parent scan configuration options |
| `gateway_hosts` | GatewayHosts | Yes | Creation of gateway hosts options |
| `host_names` | []string | Yes | Targeted hosts for parent scan. |
| `performance` | PerformanceSettings | Yes | Parent scan performance related options |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `domainType` | string | Yes | The domain type of the objects in the collection. |
| `extensions` | object | No | Additional attributes alongside the collection. |
| `id` | string | Yes | The name of this collection. |
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []PasswordObject | Yes | A list of password objects. |
...
|----------|------|----------|-------------|
| `comment` | string | No | An optional comment to explain the purpose of this password. |
| `customer` | string | No | By specifying a customer, you configure on which sites the user object will b... |
| `documentation_url` | string | No | A URL pointing to documentation or any other page. |
| `editable_by` | string | No | The owner of the password who is able to edit, delete and use existing passwo... |
| `owned_by` | string | No | Deprecated - use `editable_by` instead. The owner of the password who is able... |
| `shared` | []string | No | Each password is owned by a group of users which are able to edit, delete and... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `domainType` | string | Yes | The type of the domain-object. |
| `extensions` | PasswordExtension | Yes | All the attributes of the domain object. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []PasswordStorePasswordResponse | No | A list of password store passwords. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `hop_probes` | integer | No | Number of probes per hop |
| `max_gateway_distance` | integer | No | Maximum distance (TTL) to gateway |
| `ping_probes` | integer | No | Number of ping probes |
| `responses_timeout` | integer | No | Timeout for responses |
...
| `connect_retry` | number | No | The cooling period after a failed connect/heartbeat. |
| `heartbeat` | HeartbeatModel | No | The heartbeat interval and timeout configuration. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `only_from` | []string | Yes | Restrict access to these IP addresses. |
| `port` | integer | Yes | The TCP port to connect to. |
...
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The Pushover plug-in. |
| `priority` | PushOverOneOf | No |  |
| `sound` | SoundsOneOf | No |  |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | PushOverPrioritySelector | Yes | The pushover priority level |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `level` | string | Yes | The pushover priority level |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `expire` | integer | Yes | The expiration time in seconds |
| `level` | string | Yes | The pushover priority level |
| `receipt` | string | Yes | The receipt of the message |
| `retry` | integer | Yes | The retry interval in seconds |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `aria_label` | string | No | The aria label of the button |
| `icon` | oneOf | No | Definition of the button icon |
| `id` | string | No | The button id |
...
| `rotate` | integer | No | Rotation in degrees for the icon |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `all_stage_errors` | []oneOf | No | A list of stage errors |
| `background_job_exception` | BackgroundJobException | No | The exception details if the action was run in the background and raised an u... |
| `redirect_url` | string | No | The url to redirect to after saving the quicksetup |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | []Action | No | A collection of stage actions |
| `components` | []object | No | A collection of stage components |
| `prev_button` | oneOf | No | Definition of the `go to previous stage` button |
| `sub_title` | string | No | The sub-title of a stage |
| `title` | string | No | The title of a stage |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `button_id` | string | Yes | Unique id of the action button clicked by the user |
| `stages` | []QuickSetupStageRequest | No | A list of stages' form data |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | []Action | No | A list of all complete actions |
| `guided_mode_string` | string | No | The string for the guided mode label |
| `overview_mode_string` | string | No | The string for the overview mode label |
| `overviews` | []QuickSetupStageOverviewResponse | No | The overview of the quicksetup stages |
| `prev_button` | oneOf | No | Definition of the `go to previous stage` button |
| `quick_setup_id` | string | No | The quicksetup id |
| `stage` | QuickSetupStageStructure | No | The first stage |
...
| `prev_button` | oneOf | No | Definition of the `go to previous stage` button |
| `quick_setup_id` | string | No | The quicksetup id |
| `stages` | []QuickSetupCompleteStageResponse | No | A list of all stages and their components |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `stage_action_id` | string | Yes | The id of the stage action to be performed |
| `stages` | []QuickSetupStageRequest | No | A list of stages |
...
|----------|------|----------|-------------|
| `background_job_exception` | BackgroundJobException | No | The exception details if the action was run in the background and raised an u... |
| `stage_recap` | []object | No | A collection of widget recaps |
| `validation_errors` | oneOf | No | All formspec errors and general stage errors |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `form_data` | object | Yes | The form data entered by the user. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `parameters` | Params | No | Parameters related to the autocompleter being invoked |
...
| `warning` | string | No | An optional warning message to display to the user. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `validation_errors` | []ValidationMessage | No | All form spec validation errors |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | No | Restrict all values. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | object | No | Restrict specific values. |
| `values` | []string | Yes | A list of values to be allowed. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `event_console_alerts` | EventConsoleAlertCheckbox | No |  |
| `match_check_types` | MatchCheckTypesCheckbox | No |  |
| `match_contact_groups` | MatchContactGroupsCheckbox | No |  |
| `match_exclude_hosts` | MatchHostsCheckbox | No |  |
| `match_exclude_service_groups` | MatchServiceGroupsCheckbox | No |  |
| `match_exclude_service_groups_regex` | MatchServiceGroupRegexCheckbox | No |  |
| `match_exclude_services` | MatchServicesCheckbox | No |  |
| `match_folder` | MatchFolderCheckbox | No |  |
| `match_host_event_type` | MatchHostEventTypeCheckbox | No |  |
| `match_host_groups` | MatchHostGroupsCheckbox | No |  |
| `match_host_labels` | MatchLabelsCheckbox | No |  |
| `match_host_tags` | MatchHostTagsCheckbox | No |  |
| `match_hosts` | MatchHostsCheckbox | No |  |
| `match_notification_comment` | StringCheckbox | No |  |
| `match_only_during_time_period` | MatchTimePeriodCheckbox | No |  |
| `match_plugin_output` | StringCheckbox | No |  |
| `match_service_event_type` | MatchServiceEventTypeCheckbox | No |  |
| `match_service_groups` | MatchServiceGroupsCheckbox | No |  |
| `match_service_groups_regex` | MatchServiceGroupRegexCheckbox | No |  |
| `match_service_labels` | MatchLabelsCheckbox | No |  |
| `match_service_levels` | MatchServiceLevelsCheckbox | No |  |
| `match_services` | MatchServicesCheckbox | No |  |
| `match_sites` | MatchSitesCheckbox | No |  |
| `restrict_to_notification_numbers` | RestrictNotificationNumCheckbox | No |  |
| `throttle_periodic_notifications` | ThrottlePeriodicNotificationsCheckbox | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | Conditions | No | Conditions. |
| `folder` | string | Yes | The path name of the folder. Path delimiters can be either `~`, `/` or `\`. P... |
| `folder_index` | integer | No | The position of this rule in the chain in this folder. |
| `properties` | Properties | No | Property values of this rule. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []RuleFormSpecResponse | No | A list of rules. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `conditions` | RuleConditions | No |  |
| `contact_selection` | ContactSelection | No |  |
...
|----------|------|----------|-------------|
| `domainType` | object | No | Domain type of this object. |
| `extensions` | RuleExtensions | No | Attributes specific to rule objects. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `allow_users_to_deactivate` | Checkbox | No | If you set this option then users are allowed to deactivate notifications tha... |
| `comment` | string | No | An optional comment that may be used to explain the purpose of this object. |
| `description` | string | Yes | A description or title of this rule. |
| `do_not_apply_this_rule` | Checkbox | No | Disabled rules are kept in the configuration but are not applied. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `allow_users_to_deactivate` | CheckboxOutput | No | If you set this option then users are allowed to deactivate notifications tha... |
| `comment` | string | No | An optional comment that may be used to explain the purpose of this object. |
| `description` | string | No | A description or title of this rule. |
| `do_not_apply_this_rule` | CheckboxOutput | No | Disabled rules are kept in the configuration but are not applied. |
| `documentation_url` | string | No | An optional URL pointing to documentation or any other page. This will be dis... |
...
|----------|------|----------|-------------|
| `domainType` | object | No | Domain type of this object. |
| `extensions` | RulesetExtensions | No | Specific attributes related to rulesets. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `modem_type` | string | No | Choose what modem is used. Currently supported is only Teltonika-TRB140. |
| `modem_url` | string | Yes | Configure your modem URL here |
| `plugin_name` | object | Yes | The SMS API plug-in. |
| `timeout` | string | No | Here you can configure timeout settings |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `params` | []string | No | The given parameters are available in scripts as NOTIFY_PARAMETER_1, NOTIFY_P... |
| `plugin_name` | object | Yes | The SMS plug-in. |
...
| `privacy_protocol` | string | Yes | The privacy protocol. The only supported values in Checkmk Community are CBC-... |
| `security_name` | string | Yes | Security name |
...
| `host_label_groups` | []LabelGroupCondition | Yes | Host label conditions. Although all items in this list have a default operato... |
| `host_tags` | object | Yes | Host tags. |
| `service_label_groups` | []LabelGroupCondition | Yes | Service label conditions. Although all items in this list have a default oper... |
| `service_regex` | string | Yes | Service name regex. |
...
|----------|------|----------|-------------|
| `domainType` | string | Yes | The "domain-type" of the object. |
| `extensions` | ServiceDiscoveryResultExtensions | Yes | Additional information about the service discovery result |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `extensions` | ServiceDiscoveryResultCheckTableValueExtensions | Yes | Additional information about the check |
| `format` | object | Yes |  |
| `id` | string | Yes | The name of the check |
| `links` | []Link | Yes | list of links to other resources. |
| `memberType` | object | Yes |  |
| `title` | string | Yes | Current service phase of the check |
| `value` | string | Yes | Current service phase of the check |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `check_plugin_name` | string | Yes | The name of the check plugin |
| `host_name` | string | Yes | The name of the host |
| `service_item` | string | No | The name of the service item |
| `service_name` | string | Yes | The name of the service |
| `service_phase` | string | Yes | The name of the service phase |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `changed_labels` | object | Yes | The labels that have changed |
| `check_table` | object | Yes | The changed checks for this host |
| `host_labels` | object | Yes | The labels of the host |
| `vanished_labels` | object | Yes | The labels that have vanished |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `plugin_name` | string | No | The name of the plugin that discovered the host label |
| `value` | string | Yes | The value of the host label |
...
|----------|------|----------|-------------|
| `domainType` | string | Yes | The "domain-type" of the object. |
| `extensions` | ServiceDiscoveryRunExtensions | Yes | Additional information about the service discovery run |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `active` | boolean | Yes | Whether the service discovery run is active |
| `logs` | ServiceDiscoveryRunLogs | Yes | The logs of the service discovery run |
| `state` | string | Yes | Current state of the service discovery run |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `progress` | []string | Yes | The progress messages |
| `result` | []string | Yes | The result messages |
...
| `mode` | DowntimeMode | Yes | The mode of the downtime, either fixed or flexible. |
| `recurring` | boolean | Yes | Indicates if this downtime is time-repetitive |
| `service_description` | string | Yes | The service name if the downtime corresponds to a service, otherwise this fie... |
| `site_id` | string | Yes | The site id of the downtime. |
| `start_time` | string | Yes | The start time of the downtime. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | ServiceGroupExtensions | No | All the attributes of the domain object. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth` | AuthSelector | Yes | The authentication credentials for the ServiceNow connection |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `management_type` | MgmntTypeSelector | No |  |
| `optional_timeout` | StrValueOneOf | No |  |
| `plugin_name` | object | Yes | The ServiceNow plug-in. |
| `servicenow_url` | string | Yes | Configure your ServiceNow URL here |
| `use_site_id_prefix` | SiteIDPrefixOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `columns` | []string | No | The desired columns of the `services` table. If left empty, a default set of ... |
| `query` | Expr | No | An query expression of the Livestatus 'services' table in nested dictionary f... |
| `sites` | []string | No | Restrict the query to this particular site. |
...
|----------|------|----------|-------------|
| `columns` | []string | No | The desired columns of the `services` table. If left empty, a default set of ... |
| `host_name` | string | No | A host name. |
| `query` | Expr | No | An query expression of the Livestatus 'services' table in nested dictionary f... |
| `sites` | []string | No | Restrict the query to this particular site. |
...
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The Signl4 plug-in. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `basic_settings` | BasicSettingsCreateModel | Yes | The basic connection attributes |
| `configuration_connection` | ConnectionModel | Yes | The configuration connection attributes |
| `status_connection` | StatusConnectionModel | Yes | The status connection attributes |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `site_config` | SiteConnectionCreate | Yes | A site's connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `basic_settings` | BasicSettingsEditModel | Yes | The basic connection attributes |
| `configuration_connection` | ConnectionModel | Yes | The configuration connection attributes |
| `status_connection` | StatusConnectionModel | Yes | The status connection attributes |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `site_config` | SiteConnectionEdit | Yes | A site's connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `basic_settings` | BasicSettingsModel | Yes | The basic settings of the site connection. |
| `configuration_connection` | ConnectionModel | Yes | The configuration connection attributes |
| `logged_in` | boolean | No | If a remote site is currently logged in, this will be True, if not it will be... |
| `status_connection` | StatusConnectionModel | Yes | The status connection attributes |
...
|----------|------|----------|-------------|
| `domainType` | string | Yes | The domain type of the object. |
| `extensions` | SiteConnectionExtensionsModel | Yes | The configuration attributes of a site. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []SiteConnectionModel | Yes | A list of site configuration objects. |
...
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The Slack plug-in. |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
|----------|------|----------|-------------|
| `option` | string | Yes |  |
| `url` | string | Yes | Configure your Slack or Mattermost Webhook URL here. Slack Webhooks must use ... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `base_oid` | string | No | The base OID for the trap content |
| `destination_ip` | string | Yes | IP address of the Spectrum server receiving the SNMP trap |
| `plugin_name` | object | Yes | The Spectrum plug-in. |
...
| `connection` | oneOf | Yes | When connecting to remote site please make sure that Livestatus over TCP is a... |
...
| `proxy` | oneOf | Yes | The Livestatus proxy daemon configuration attributes. |
| `status_host` | oneOf | Yes | By specifying a status host for each non-local connection you prevent Multisi... |
| `url_prefix` | string | No | The URL prefix will be prepended to links of add-ons like NagVis when a link ... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `status_host_set` | string | Yes | disabled for 'no status host' |
...
| `status_host_set` | string | Yes | enabled for 'use the following status host' |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `JobException` | []string | No | The exception logs of the background job |
| `JobProgressUpdate` | []string | No | The progress update logs of the background job |
| `JobResult` | []string | No | The result logs of the background job |
...
| `tag_id` | string | No | Tag groups tag ids are available via the host tag group endpoint. |
| `tag_type` | string | No | Identifies the type of host tag. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | TimePeriodAttrsResponse | No | The time period attributes. |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | EmailAndDisplayName | No | The email address and visible name used in the Reply-To header of notificatio... |
...
| `socket_type` | string | Yes | The unix socket type |
...
|----------|------|----------|-------------|
| `data` | object | Yes | The data of the configuration entity |
| `entity_id` | string | Yes | Object id of the configuration entity |
| `entity_type` | string | Yes | Type of configuration entity |
| `entity_type_specifier` | string | Yes | Specifier for the entity type |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | FolderUpdateAttribute | No | Replace all attributes with the ones given in this field. Already setattribut... |
...
| `update_attributes` | FolderUpdateAttribute | No | Just update the folder attributes with these attributes. The previously set a... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | HostUpdateAttribute | No | Replace all currently set attributes on the host, with these attributes. Any ... |
| `remove_attributes` | []string | No | A list of attributes which should be removed. Can't be used together with att... |
| `update_attributes` | HostUpdateAttribute | No | Just update the hosts attributes with these attributes. The previously set at... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth_option` | AuthUpdateOption | No | Authentication option for the user |
...
| `idle_timeout` | IdleOption | No | Idle timeout for the user |
| `interface_options` | UserInterfaceUpdateAttributes | No |  |
| `language` | string | No | Configure the language to be used by the user in the user interface. Omitting... |
| `pager_address` | string | No |  |
| `roles` | []string | No | The list of assigned roles to the user |
| `start_url` | string | No | The URL that the user should be redirected to after login. There is a 'defaul... |
...
| `params` | ProxyParamsModel | No | The live status proxy daemon parameters. |
| `tcp` | ProxyTcpModel | No | Allow access via TCP configuration. |
| `use_livestatus_daemon` | string | Yes | Use livestatus daemon with livestatus proxy. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `warning` | string | Yes | The warning to be dismissed. |
...
| `main_menu_icons` | string | No | This option decides if colored icon should be shown foe every entry in the ma... |
| `mega_menu_icons` | string | No | Deprecated - use `main_menu_icons` instead. |
| `navbar_changes_action` | string | No | The view mode for activating changes. Either the quick activation slideout or... |
| `navigation_bar_icons` | string | No | This option decides if icons in the navigation bar should show/hide the respe... |
| `show_mode` | string | No | This option decides what show mode should be used for unvisited menus. Altern... |
| `sidebar_position` | string | No | The position of the sidebar |
...
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []UserRoleModel | Yes | A list of user role objects |
...
|----------|------|----------|-------------|
| `domainType` | string | Yes | The domain type of the object. |
| `extensions` | UserRoleExtensionsModel | Yes | All the data and metadata of this user role. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []LinkModel | Yes | List of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sync_with_ldap_connections` | string | Yes | Sync with all connections. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sync_with_ldap_connections` | string | Yes | Sync with disabled connections. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `ldap_connections` | []string | Yes | A list of existing ldap connections. |
| `sync_with_ldap_connections` | string | Yes | Sync with ldap connections. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `location` | []string | No | Location of the error |
| `message` | string | No | Error message |
| `replacement_value` | string | No | Invalid value |
...
| `disable_ssl_cert_verification` | Checkbox | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | HttpProxyOneOf | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The Victorops plug-in. |
