...
| Code | Description | Schema |
|------|-------------|--------|
| 200 | OK: The activation has been completed. | [ActivationRunResponse](schemas.md#activationrunresponse) |
...
| Name | In | Type | Required | Description |
|------|-----|------|----------|-------------|
| `downtime_id` | path | integer | Yes | The id of the downtime |
...
**Request Body:** [UpdateAndAcknowledgeEvent](schemas.md#updateandacknowledgeevent)
