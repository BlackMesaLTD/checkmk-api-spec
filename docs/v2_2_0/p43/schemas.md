...
- [CheckboxHostEventType1](#checkboxhosteventtype1)
- [CheckboxLabel](#checkboxlabel)
- [CheckboxLabel1](#checkboxlabel1)
- [CheckboxMatchHostTags](#checkboxmatchhosttags)
- [CheckboxMatchHostTags1](#checkboxmatchhosttags1)
...
- [CheckboxRestrictNotificationNumbers1](#checkboxrestrictnotificationnumbers1)
- [CheckboxServiceEventType](#checkboxserviceeventtype)
- [CheckboxServiceEventType1](#checkboxserviceeventtype1)
...
- [CheckboxThrottlePeriodicNotifcations1](#checkboxthrottleperiodicnotifcations1)
- [CheckboxWithFolderStr](#checkboxwithfolderstr)
- [CheckboxWithFolderStr1](#checkboxwithfolderstr1)
- [CheckboxWithFromToServiceLevels](#checkboxwithfromtoservicelevels)
- [CheckboxWithFromToServiceLevels1](#checkboxwithfromtoservicelevels1)
...
- [CheckboxWithListOfLabels1](#checkboxwithlistoflabels1)
...
- [CheckboxWithListOfServiceGroupsRegex1](#checkboxwithlistofservicegroupsregex1)
- [CheckboxWithListOfSites](#checkboxwithlistofsites)
- [CheckboxWithListOfStr](#checkboxwithlistofstr)
- [CheckboxWithListOfStr1](#checkboxwithlistofstr1)
...
- [FromToNotificationNumbers1](#fromtonotificationnumbers1)
- [FromToServiceLevels](#fromtoservicelevels)
- [FromToServiceLevels1](#fromtoservicelevels1)
- [Get](#get)
...
- [MatchCustomMacros1](#matchcustommacros1)
...
- [ServiceEventType1](#serviceeventtype1)
...
- [ServiceGroupsRegex1](#servicegroupsregex1)
...
- [SysLogToFromPriorities1](#syslogtofrompriorities1)
...
- [ThrottlePeriodicNotifications1](#throttleperiodicnotifications1)
...
| `plugin_name` | string | Yes | The plugin name. |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | FromToNotificationNumbers1 | No |  |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | ThrottlePeriodicNotifications1 | No |  |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | []CheckboxLabel1 | No | A list of key, value label pairs |
...
|----------|------|----------|-------------|
| `state` | string | No | To enable or disable this field |
| `value` | SysLogToFromPriorities1 | No |  |
...
| `match_check_types` | CheckboxWithListOfStr1 | No |  |
| `match_contact_groups` | CheckboxWithListOfStr1 | No |  |
| `match_exclude_hosts` | CheckboxWithListOfStr1 | No |  |
| `match_exclude_service_groups` | CheckboxWithListOfStr1 | No |  |
| `match_exclude_service_groups_regex` | CheckboxWithListOfServiceGroupsRegex1 | No |  |
| `match_exclude_services` | CheckboxWithListOfStr1 | No |  |
| `match_folder` | CheckboxWithFolderStr1 | No |  |
| `match_host_event_type` | CheckboxHostEventType1 | No |  |
| `match_host_groups` | CheckboxWithListOfStr1 | No |  |
| `match_host_labels` | CheckboxWithListOfLabels1 | No |  |
| `match_host_tags` | CheckboxMatchHostTags1 | No |  |
| `match_hosts` | CheckboxWithListOfStr1 | No |  |
| `match_notification_comment` | CheckboxWithStrValue1 | No |  |
| `match_only_during_time_period` | CheckboxWithStrValue1 | No |  |
| `match_plugin_output` | CheckboxWithStrValue1 | No |  |
| `match_service_event_type` | CheckboxServiceEventType1 | No |  |
| `match_service_groups` | CheckboxWithListOfStr1 | No |  |
| `match_service_groups_regex` | CheckboxWithListOfServiceGroupsRegex1 | No |  |
| `match_service_labels` | CheckboxWithListOfLabels1 | No |  |
| `match_service_levels` | CheckboxWithFromToServiceLevels1 | No |  |
| `match_services` | CheckboxWithListOfStr1 | No |  |
| `match_sites` | CheckboxWithListOfStr1 | No |  |
| `restrict_to_notification_numbers` | CheckboxRestrictNotificationNumbers1 | No |  |
| `throttle_periodic_notifications` | CheckboxThrottlePeriodicNotifcations1 | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `all_contacts_of_the_notified_object` | Checkbox1 | No |  |
| `all_users` | Checkbox1 | No |  |
| `all_users_with_an_email_address` | Checkbox1 | No |  |
| `explicit_email_addresses` | CheckboxWithListOfStr1 | No |  |
| `members_of_contact_groups` | CheckboxWithListOfStr1 | No |  |
| `restrict_by_contact_groups` | CheckboxWithListOfStr1 | No |  |
| `restrict_by_custom_macros` | MatchCustomMacros1 | No |  |
| `the_following_users` | CheckboxWithListOfStr1 | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `plugin_name` | string | Yes | The custom plugin name |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `match_event_comment` | CheckboxWithStrValue1 | No |  |
| `match_rule_ids` | CheckboxWithListOfStr1 | No |  |
| `match_syslog_facility` | CheckboxWithStrValue1 | No |  |
| `match_syslog_priority` | CheckboxWithSysLogPriority1 | No |  |
...
| `state` | string | No | To enable or disable this field |
| `subject_for_bulk_notifications` | CheckboxWithStrValue1 | No |  |
...
|----------|------|----------|-------------|
| `option` | string | No |  |
| `plugin_params` | object | No | The plugin name and configuration parameters defined. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `range` | string | No | The pre-defined time range. |
| `range_type` | string | Yes | The type of the time range. |
