...
| `match_folder` | CheckboxWithFolderStr | No |  |
...
| `match_notification_comment` | CheckboxWithStrValue | No |  |
| `match_only_during_time_period` | CheckboxWithStrValue | No |  |
| `match_plugin_output` | CheckboxWithStrValue | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `match_event_comment` | CheckboxWithStrValue | No |  |
| `match_rule_ids` | CheckboxWithListOfStr | No |  |
| `match_syslog_facility` | CheckboxWithStrValue | No |  |
