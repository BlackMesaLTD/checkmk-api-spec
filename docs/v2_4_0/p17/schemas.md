...
- [Action](#action)
- [ActionResultObject](#actionresultobject)
- [ActionResultObjectValue](#actionresultobjectvalue)
- [ActionResultScalar](#actionresultscalar)
- [ActionResultScalarValue](#actionresultscalarvalue)
...
- [Api403CustomError5](#api403customerror5)
...
- [Api422CustomError4](#api422customerror4)
- [Api422CustomError5](#api422customerror5)
...
- [BaseSettingMode](#basesettingmode)
...
- [BuiltinCertificate](#builtincertificate)
...
- [ConfigurationConnectionWithReplicationAttributes](#configurationconnectionwithreplicationattributes)
- [ConfigurationConnectionWithoutReplicationAttributes](#configurationconnectionwithoutreplicationattributes)
- [ConnectedSiteAttributes](#connectedsiteattributes)
- [ConnectionConfig](#connectionconfig)
- [ConnectionFetchPhaseOne](#connectionfetchphaseone)
- [ConnectionMode](#connectionmode)
- [ContactGroup](#contactgroup)
- [ContactGroupCnFromLdapDn](#contactgroupcnfromldapdn)
- [ContactGroupCollection](#contactgroupcollection)
- [ContactGroupExtensions](#contactgroupextensions)
- [ContactGroupFromAttributeValue](#contactgroupfromattributevalue)
- [ContactGroupMapValue](#contactgroupmapvalue)
...
- [CreateCreationRuleAttribute](#createcreationruleattribute)
- [CreateDCD](#createdcd)
...
- [CreatePiggybackDCD](#createpiggybackdcd)
...
- [CreationRuleAttribute](#creationruleattribute)
...
- [GeneralPropertiesCreate](#generalpropertiescreate)
- [Get](#get)
- [GetCustomGraph](#getcustomgraph)
- [GetGraph](#getgraph)
- [GetMetric](#getmetric)
...
- [LDAPGroupsToRolesRequestWithCustomRoles](#ldapgroupstorolesrequestwithcustomroles)
- [LDAPGroupsToRolesSelector](#ldapgroupstorolesselector)
- [LDAPGroupsToRolesWithCustomRoles](#ldapgroupstoroleswithcustomroles)
...
- [LDAPSyncPluginsRequestWithCustomAttributes](#ldapsyncpluginsrequestwithcustomattributes)
- [LDAPSyncPluginsWithCustomAttributes](#ldapsyncpluginswithcustomattributes)
...
- [Levels](#levels)
- [LicenceSettingMode](#licencesettingmode)
- [LicenseCredentials](#licensecredentials)
...
- [MonitoringLevels](#monitoringlevels)
...
- [OneOfConnector](#oneofconnector)
- [OnlineSettingMode](#onlinesettingmode)
...
- [PiggybackConnector](#piggybackconnector)
- [PluginBase](#pluginbase)
- [PluginNameBuiltInOrCustom](#pluginnamebuiltinorcustom)
- [PluginOptionsSelector](#pluginoptionsselector)
- [PluginPercentageStateComputedResult](#pluginpercentagestatecomputedresult)
...
- [SAMLConnectionConfig](#samlconnectionconfig)
- [SAMLConnectionCreateRequest](#samlconnectioncreaterequest)
- [SAMLConnectionResponse](#samlconnectionresponse)
- [SAMLConnectionResponseCollection](#samlconnectionresponsecollection)
- [SLAComputeRequest](#slacomputerequest)
- [SLAComputeResult](#slacomputeresult)
- [SLAComputeTarget](#slacomputetarget)
- [SLAComputedResultCollection](#slacomputedresultcollection)
...
- [ServicePercentagePeriodResult](#servicepercentageperiodresult)
- [ServiceStatePercentageConfig](#servicestatepercentageconfig)
- [ServiceStatePercentageStateRequirement](#servicestatepercentagestaterequirement)
- [ServiceStatePercentageSubResult](#servicestatepercentagesubresult)
- [ShowDCD](#showdcd)
...
- [TimeRangeOutput](#timerangeoutput)
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `button` | object | No | Definition of the action button |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `extensions` | object | No | Some attributes alongside the result. |
| `links` | []Link | Yes | list of links to other resources. |
| `result` | object | No | The result of the action. In this case, an object. |
| `resultType` | string | No | The type of the result. |
...
| `extensions` | object | No | Some attributes alongside the result. |
| `links` | []Link | Yes | list of links to other resources. |
| `result` | object | No | The scalar result of the action. |
| `resultType` | string | No | The type of the result. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | object | No | The activation run attributes with status. |
| `id` | string | No | The unique identifier for this activation run. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | The activation run status. |
...
| `value` | []AgentObject | No | A list of agent objects. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `key_id` | integer | Yes | The id under that the desired agent signature key is stored |
| `passphrase` | string | Yes | The password to unlock the agent signature key |
...
| `sort_order_for_bulk_notifications` | SortOrderOneOf | Yes |  |
...
| `status` | object | No | The status of the background job |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `log_info` | object | No | The logs of the background job |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `mode` | string | Yes | With which mode to perform the license verification: 'online' or 'offline'. I... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connectee` | object | Yes | The ID of the site accepting the connection. |
| `connecter` | object | Yes | The ID of the site initiating the connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connectee` | object | No | The attributes of the site accepting the connection. |
| `connecter` | object | No | The attributes of the site initiating the connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connection_config` | object | Yes | The connection configuration. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | object | No | The configuration attributes of a broker peer to peer connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | string | Yes | Use the certificate that comes with Checkmk. |
...
| `options` | object | Yes | The discovery options for the bulk discovery |
...
| `bake_agent_package` | boolean | No | Bake agent packages for this folder even if it is empty. |
...
| `is_trusted` | boolean | No | When this option is enabled the central site might get compromised by a rogue... |
| `message_broker_port` | integer | No | The port used for the message broker to exchange messages. |
...
| `user_sync` | object | No | By default the users are synchronized automatically in the interval configure... |
...
| `enable_replication` | object | Yes | Replication allows you to manage several monitoring sites with a logically ce... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `enable_replication` | object | Yes | Replication is disabled. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `checkmk_server_url` | string | Yes | URL of the CheckMK server. |
| `identity_provider_metadata` | object | Yes | Identity provider metadata. |
| `identity_provider_timeout` | object | No | Configured timeouts. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connection_id` | string | Yes | The connection id |
| `site_id` | string | Yes | The site id |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | Yes | Attribute for contact group sync. |
| `type` | string | Yes | The attribute value will be interpreted as a distinguished name (DN). The com... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `inventory_paths` | object | No | Permitted HW/SW Inventory paths. |
...
|----------|------|----------|-------------|
| `attribute` | string | Yes | Attribute for contact group sync. |
| `type` | string | Yes | The attribute value will be mapped to an existing contact group with the same... |
...
|----------|------|----------|-------------|
| `attribute` | string | Yes | Attribute for contact group sync. |
| `mapping` | []ContactGroupMapping | Yes | Mapping of attribute values to contact groups. |
| `type` | string | Yes | The attribute value will be compared to values in the mapping. The contact gr... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute_value` | string | Yes | Value to compare to the attribute. |
| `contact_groups` | []string | Yes | List of contact groups. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `delete_hosts` | boolean | No | Delete the hosts created by this connection whose piggyback data is no longer... |
| `folder_path` | string | No | Name of the folder the connection creates hosts in. Once created, you can cho... |
| `host_attributes` | oneOf | No | Attributes to set on the newly created host. |
| `matching_hosts` | []string | No | Restrict host creation using regular expressions. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `comment` | string | No | Add a comment to your dynamic host configuration |
| `connector` | object | Yes | The connector configuration. |
| `dcd_id` | string | Yes | The unique ID of the Piggyback dynamic host configuration to be created. |
| `disabled` | boolean | No | The dynamic host configuration can be disabled but will remain part of the site. |
| `documentation_url` | string | No | Add a URL linking to a documentation or any other page. You can use either gl... |
| `site` | string | Yes | Specify the site where you want this connector to run. Only this site will pr... |
| `title` | string | Yes | Name your connection for easy recognition. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connector_type` | object | Yes | The name of the plug-in to be used. Currently only piggyback is supported. |
| `creation_rules` | []CreateCreationRuleAttribute | No | The first matching rule is used. You must specify at least one rule. |
| `discover_on_creation` | boolean | No | Automatically runs a service discovery on any new hosts created by this conne... |
| `interval` | integer | No | The interval in seconds the connection will be executed to check the availabl... |
| `max_cache_age` | integer | No | Seconds to keep hosts when piggyback source only sends piggyback data for oth... |
| `no_deletion_time_after_init` | integer | No | Seconds to prevent host deletion after site startup, e.g. when booting the Ch... |
| `restrict_source_hosts` | []string | No | Only care about hosts that receive piggyback data from hosts which name match... |
| `validity_period` | integer | No | Seconds to continue consider outdated piggyback data as valid |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `certificate` | string | Yes | Public key in PEM format. Must be a single certificate, not a chain. |
| `private_key` | string | Yes | Private key in PEM format. |
| `type` | string | Yes | Specify a custom certificate. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `end` | string | Yes | The end datetime of the SLA compute period range. The format has to conform t... |
| `range_type` | string | Yes | The type of the time range. |
| `start` | string | Yes | The start datetime of the SLA compute period range. The format has to conform... |
...
| `comment` | string | No | Add a comment to your dynamic host configuration |
| `connector` | object | Yes | The connector configuration. |
| `dcd_id` | string | Yes | The unique identifier of the dynamic host configuration. |
| `disabled` | boolean | No | The dynamic host configuration can be disabled but will remain part of the site. |
| `documentation_url` | string | No | Add a URL linking to a documentation or any other page. You can use either gl... |
| `site` | string | Yes | Specify the site where you want this connector to run. Only this site will pr... |
| `title` | string | Yes | Name your connection for easy recognition. |
...
| `extensions` | object | No | Response data for entity creation |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `aggregation` | string | No | A result that contains multiple metrics of the same type can be aggregated to... |
| `filter` | object | Yes | Filter for hosts, services and sites. Entries of the filter are combined with... |
...
| `id` | string | Yes | A SAML connection ID string. |
| `name` | string | Yes | Display name for the SAML connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `custom_graph_id` | string | Yes | The ID of the requested custom graph. |
| `reduce` | string | No | Specify how to reduce a segment of data points to a single data point of the ... |
| `time_range` | object | Yes | The time range from which to source the metrics. |
...
| `mode` | object | Yes | The mode of the downtime, either fixed or flexible. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | string | Yes | Automatically determine identity provider metadata by querying an endpoint. |
| `url` | string | Yes | URL to fetch identity provider metadata from. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | string | Yes | Static configuration in XML format. |
| `xml` | string | Yes | Identity provider metadata xml. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connect` | integer | No | Connect timeout. |
| `read` | integer | No | Read timeout. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attributes` | object | No | Restrict single values. |
| `columns` | object | No | Restrict table columns. |
| `nodes` | object | No | Restrict subcategories. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth` | object | Yes | The authentication credentials for the Jira connection |
| `disable_ssl_cert_verification` | object | Yes | Ignore unverified HTTPS request warnings. Use with caution. |
| `graphs_per_notification` | object | No | Here you can set a limit for the number of graphs that are displayed in a not... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `bind_credentials` | object | No | The credentials used to connect to the LDAP server. |
| `connect_timeout` | object | No | If the connection timeout is set and its value. |
| `connection_suffix` | object | No | If the connection suffix is enabled and what its set to. |
| `directory_type` | object | No | The credentials to be used to connect to the LDAP server. The used account mu... |
| `ldap_version` | object | No | If the ldap version is set and the version it's set to. Either 2 or 3. |
| `page_size` | object | No | If the page size is enabled and its value. |
| `response_timeout` | object | No | Enable the response timeout and define its value. |
| `ssl_encryption` | string | No | Connect to the LDAP server with a SSL encrypted connection. The trusted certi... |
| `tcp_port` | object | No | The TCP port to be used to connect to the LDAP server. |
...
| `other` | LDAPOther | No |  |
| `sync_plugins` | LDAPSyncPluginsWithCustomAttributes | No |  |
| `users` | LDAPUsers | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `general_properties` | object | Yes | General properties of an LDAP connection. |
| `groups` | object | No | The LDAP group configuration |
| `ldap_connection` | object | Yes | The LDAP connection configuration |
| `other` | object | No | Other config options for the LDAP connection. |
| `sync_plugins` | object | No | The LDAP sync plug-ins configuration |
| `users` | object | No | The LDAP user configuration |
...
| `connect_timeout` | object | No | If the connection timeout is set and its value. |
| `connection_suffix` | object | No | If the connection suffix is enabled and what its set to. |
| `directory_type` | object | Yes | The credentials to be used to connect to the LDAP server. The used account mu... |
| `ldap_version` | object | No | If the ldap version is set and the version it's set to. |
| `page_size` | object | No | If the page size is enabled and its value. |
| `response_timeout` | object | No | Enable the response timeout and define its value. |
| `ssl_encryption` | string | No | Connect to the LDAP server with a SSL encrypted connection. The trusted certi... |
| `tcp_port` | object | No | The TCP port to be used to connect to the LDAP server. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | object | No | The configuration attributes of a user LDAP connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `custom_time_range` | object | No | Here you can specify a time range where no notifications are generated. |
...
| `member_attribute` | object | No | Enable and define a member attribute. |
| `search_filter` | object | No | Enable and define an optional LDAP filter. |
...
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `no_permissions` | []LDAPRoleElementRequest | No |  |
| `state` | object | Yes | This config parameter is enabled. |
...
| `handle_nested` | boolean | No | Once you enable this option, this plug-in will not only handle direct group m... |
| `no_permissions` | []LDAPRoleElement | No |  |
| `state` | string | No |  |
...
| `value` | object | No | The value of the attribute to set |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sync_interval` | object | No | This option defines the interval of the LDAP synchronization. This setting is... |
...
| `attribute_to_set` | string | Yes | The attribute to set |
| `group_cn` | string | Yes | The common name of the group |
| `value` | object | Yes | The value to set |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `alias` | object | No | Enables and populates the alias attribute of the Setup user by synchronizing ... |
| `authentication_expiration` | object | No | This plug-in when enabled fetches all information which is needed to check wh... |
| `contact_group_membership` | object | No | This plug-in allows you to synchronize group memberships of the LDAP user acc... |
| `disable_notifications` | object | No | When this option is enabled you will not get any alerts or other notification... |
| `email_address` | object | No | Synchronizes the email of the LDAP user account into Checkmk when enabled |
| `groups_to_custom_user_attributes` | object | No | This plug-in allows you to synchronize group memberships of the LDAP user acc... |
| `groups_to_roles` | object | No | Configures the roles of the user depending on its group memberships in LDAP. ... |
| `mega_menu_icons` | object | No | When enabled, in the mega menus you can select between two options: Have a gr... |
| `navigation_bar_icons` | object | No | With this option enabled you can define if icons in the navigation bar should... |
| `pager` | object | No | When enabled, this plug-in synchronizes a field of the users LDAP account to ... |
| `show_mode` | object | No | In some places like e.g. the main menu Checkmk divides features, filters, inp... |
| `start_url` | object | No | The start URL to display in main frame. |
| `temperature_unit` | object | No | Set the temperature unit used for graphs and perfometers. The default unit ca... |
| `ui_sidebar_position` | object | No | The sidebar position |
| `ui_theme` | object | No | The user interface theme |
| `visibility_of_hosts_or_services` | object | No | When this option is checked, the status GUI will only display hosts and servi... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `alias` | object | No | Populates the alias attribute of the Setup user by synchronizing an attribute... |
| `authentication_expiration` | object | No | This plug-in fetches all information which are needed to check whether or not... |
| `contact_group_membership` | object | No | Adds the user to contact groups based on the group memberships in LDAP. This ... |
| `disable_notifications` | object | No | When this option is active you will not get any alerts or other notifications... |
| `email_address` | object | No | Synchronizes the email of the LDAP user account into Checkmk |
| `groups_to_custom_user_attributes` | object | No | Sets custom user attributes based on the group memberships in LDAP. This plug... |
| `groups_to_roles` | object | No | Configures the roles of the user depending on its group memberships in LDAP. |
| `mega_menu_icons` | object | No | In the mega menus you can select between two options: Have a green icon only ... |
| `navigation_bar_icons` | object | No | With this option you can define if icons in the navigation bar should show a ... |
| `pager` | object | No | This plug-in synchronizes a field of the users LDAP account to the pager attr... |
| `show_mode` | object | No | In some places like e.g. the main menu Checkmk divides features, filters, inp... |
| `start_url` | object | No | The start URL to display in main frame. |
| `temperature_unit` | object | No | Set the temperature unit used for graphs and perfometers. The default unit ca... |
| `ui_sidebar_position` | object | No | The sidebar position |
...
| `filter_group` | object | No | Enable and define the DN of a group object which is used to filter the users. |
| `search_filter` | object | No | Enable and define an optional LDAP filter. |
...
| `user_id_attribute` | object | No | Enable and define a user ID attribute. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `crit` | number | No | The critical level of the SLA agreement. |
| `warn` | number | No | The warning level of the SLA agreement. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `settings` | object | Yes | The settings required for the configuration of licensing settings |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `assertion_consumer_service_endpoint` | string | Yes | Assertion Consumer Service endpoint for this connection. |
| `entity_id` | string | Yes | Entity ID for this connection. |
| `metadata_endpoint` | string | Yes | Metadata endpoint for this connection. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `levels` | object | No | The levels of the SLA agreement. |
| `limit` | number | No | The limit of the SLA agreement. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `credentials` | object | Yes | The credentials to use for online license configuration |
| `mode` | string | Yes | With which mode to perform the license verification: 'online' or 'offline'. I... |
...
| `extra_properties` | object | No | A list of extra properties that will be included in the notification |
| `http_proxy` | object | Yes | Use the proxy settings from the environment variables. The variables NO_PROXY... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `configuration` | object | Yes | Parent scan configuration options |
| `gateway_hosts` | object | Yes | Creation of gateway hosts options |
| `host_names` | []string | Yes | Targeted hosts for parent scan. |
| `performance` | object | Yes | Parent scan performance related options |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connector_type` | object | No | The type of the connector. |
| `creation_rules` | []CreationRuleAttribute | No | The first matching rule is used. You must specify at least one rule. |
| `discover_on_creation` | boolean | No | Automatically runs a service discovery on any new hosts created by this conne... |
| `interval` | integer | No | The interval in seconds the connection will be executed to check the availabl... |
| `max_cache_age` | integer | No | Seconds to keep hosts when piggyback source only sends piggyback data for oth... |
| `no_deletion_time_after_init` | integer | No | Seconds to prevent host deletion after site startup, e.g. when booting the Ch... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `period_results` | []ServicePercentagePeriodResult | No | The period results of the service percentage state computation plugin. |
| `plugin_id` | string | No | The id of the plugin. |
| `time_range_sla_duration` | number | Yes | The duration of the time range in seconds. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `range` | string | Yes | The pre-defined time range. |
| `range_type` | string | Yes | The type of the time range. |
...
|----------|------|----------|-------------|
| `state` | string | Yes | To enable or disable this field |
| `value` | object | Yes | The pushover priority level |
...
| `background_job_exception` | object | No | The exception details if the action was run in the background and raised an u... |
...
| `stages` | []object | No | A list of stages' form data |
...
| `stage` | object | No | The first stage |
...
| `stages` | []object | No | A list of stages |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `attribute` | string | Yes | Attribute which will be checked for a match. |
| `roles` | object | No | Mapping of roles and attribute values. Roles will be added to the user if one... |
| `type` | string | Yes |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `connection_config` | object | Yes | SAML connection configuration. |
| `general_properties` | object | Yes | General properties of a SAML connection. |
| `metadata` | object | Yes | Generated service provider metadata. |
| `security` | object | Yes | SAML security configuration. |
| `users` | object | Yes | User sync configuration. |
...
| `connection_config` | object | Yes | SAML connection configuration. |
| `general_properties` | object | Yes | General properties of a SAML connection. |
| `security` | object | No | SAML security configuration. |
| `users` | object | Yes | User sync configuration. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the object. |
| `extensions` | object | Yes | The configuration attributes of a user SAML connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| `links` | []Link | Yes | list of links to other resources. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
| `value` | []SAMLConnectionResponse | No | A list of SAML connections. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `sla_compute_targets` | []SLAComputeTarget | Yes | The SLA compute targets for which the SLA should be computed. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `results` | []PluginResult | No | The period results of the SLA computation. |
| `service` | object | No | The service entity for which the SLA is computed. |
| `sla_id` | string | No | The ID of the SLA. |
| `sla_period` | string | No | The configured SLA period. |
| `time_range` | object | No | The time range for which the SLA is computed. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `services` | []Service | Yes | The services for which the SLA should be computed. |
| `sla_ids` | []string | Yes | The ids of the SLA configurations for which the SLA should be computed. |
| `time_ranges` | []TimeRange1 | Yes | The time ranges for which the SLA should be computed. |
...
|----------|------|----------|-------------|
| `domainType` | object | No | The domain type of the objects in the collection |
| `value` | []SLAComputeResult | No | The list of SLA computed results. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `decrypt_auth_certificate` | object | No | Certificate to decrypt authentication responses. |
| `signing_certificate` | object | No | Certificate to sign requests to the identity provider. |
...
|----------|------|----------|-------------|
| `host_name` | string | Yes |  |
| `service_description` | string | Yes | The service whose SLA data is to be computed. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `auth` | object | Yes | The authentication credentials for the ServiceNow connection |
| `http_proxy` | object | Yes | Use the proxy settings from the environment variables. The variables NO_PROXY... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `host_name` | string | No | The name of the host. |
| `service_description` | string | No | The description of the service for which the SLA is computed. |
| `site` | string | No | The ID of the site. |
...
| `query` | object | No | An query expression of the Livestatus 'services' table in nested dictionary f... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `duration` | number | No | The duration of the time range in seconds. |
| `sla_agreement` | string | Yes | Whether the SLA agreement was broken or fulfilled during this period.The agre... |
| `state_durations` | object | No | The percentage of the duration for which the service was in the underlying st... |
| `sub_results` | []ServiceStatePercentageSubResult | No | The sub results of the service state percentage period result. |
| `time_range` | object | No | The time range of the period. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `monitoring_levels` | object | No | The monitoring levels for which the SLA agreement is checked. |
| `state_requirement` | object | No | The configured state for which the SLA agreement is checked. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `condition` | string | No | The reference condition for which the observed state is compared to. |
| `observed_percentage` | number | No | The reference percentage value for which the condition is checked. |
| `observed_state` | string | No | The configured state for which the SLA agreement is checked. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `config` | ServiceStatePercentageConfig | No |  |
| `state` | object | No | The state of the SLA agreement |
...
|----------|------|----------|-------------|
| `domainType` | object | Yes | The domain type of the object. |
| `extensions` | object | No | All the data and metadata of this dcd connection. |
| `id` | string | No | The unique identifier for this domain-object type. |
| `links` | []Link | Yes | list of links to other resources. |
| `members` | object | No | The container for external resources, like linked foreign objects or actions. |
| `title` | string | No | A human readable title of this object. Can be used for user interfaces. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `crit` | number | No | The time duration for how long the service was in the CRIT state. |
| `ok_indowntime` | number | No | The time duration for how long the service was in the OK state or in downtime. |
| `unknown_unmonitored` | number | No | The time duration for how long the service was in the UNKNOWN state or unmoni... |
| `warn` | number | No | The time duration for how long the service was in the WARN state. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `deviation_state` | string | No | The deviation state of the SLA agreement. The deviation state is respective t... |
| `deviation_value` | number | No | The deviation value of the SLA agreement. The deviation value is the differen... |
| `sla_agreement` | string | Yes | Whether the SLA agreement was broken or fulfilled during this period.The agre... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `end` | string | Yes | The end time of the period |
| `start` | string | Yes | The start time of the period |
...
| `update_attributes` | oneOf | No | Just update the folder attributes with these attributes. The previously set a... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `contact_groups` | object | No | Contact group sync configuration. |
| `email_attribute` | string | No | Attribute used for the email. |
| `full_name_attribute` | string | No | Attribute used for the full name, if not set the ID is used. |
| `id_attribute` | string | Yes | Attribute used to uniquely identify the users. |
| `roles` | object | No | Role sync configuration. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `invalid_value` | string | No | Invalid value |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `VERSION` | string | Yes | The version of the response |
| `certificate` | string | Yes | The certificate of the response |
| `created_at` | integer | Yes | The creation timestamp |
| `payload` | object | Yes | The payload of the response |
| `request_id` | string | Yes | The ID of the request |
| `response_id` | string | Yes | The ID of the response |
| `signature` | string | Yes | The signature of the response |
