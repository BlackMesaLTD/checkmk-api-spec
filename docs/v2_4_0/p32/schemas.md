...
- [LDAPGroupsToRolesRequest](#ldapgroupstorolesrequest)
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `disable_ssl_cert_verification` | object | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `http_proxy` | object | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
...
| `explicit_email_addresses` | object | No | Send notifications to the following explicit email addresses (non-CSE edition... |
...
| `host_summary` | object | No | Here you are allowed to use all macros that are defined in the notification c... |
...
| `label` | object | No | Here you can set a custom label for new issues. If not set, 'monitoring' will... |
| `monitoring_url` | string | Yes | Configure the base URL for the monitoring web GUI here. Include the site name... |
| `optional_timeout` | object | No | Here you can configure timeout settings. |
| `plugin_name` | object | Yes | The Jira plug-in. |
| `priority_id` | object | No | The numerical Jira priority ID. If not set, it will be retrieved from a custo... |
| `project_id` | string | No | The numerical Jira project ID. If not set, it will be retrieved from a custom... |
| `resolution_id` | object | No | The numerical Jira resolution transition ID. 11 - 'To Do', 21 - 'In Progress'... |
| `service_custom_id` | string | Yes | The numerical Jira custom field ID for service problems |
| `service_summary` | object | No | Here you are allowed to use all macros that are defined in the notification c... |
| `site_custom_id` | object | No | The numerical ID of the Jira custom field for sites. Please use this option i... |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | object | No | Custom actions that will be available for the alert. |
| `additional_responders` | object | No | Additional non-team responders (user, on-call schedule, escalation policy) to... |
| `api_key` | OpsGenisStoreOrExplicitKeySelector | Yes |  |
| `desc_for_host_alerts` | object | No | Description field of host alert that is generally used to provide a detailed ... |
| `desc_for_service_alerts` | object | No | Description field of service alert that is generally used to provide a detail... |
| `disable_ssl_cert_verification` | object | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `entity` | object | No | Is used to specify which domain the alert is related to |
| `extra_properties` | object | No | A list of extra properties that will be included in the notification |
| `http_proxy` | object | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `message_for_host_alerts` | object | No |  |
| `message_for_service_alerts` | object | No |  |
| `note_while_closing` | object | No | Additional note that will be added while closing the alert |
| `note_while_creating` | object | No | Additional note that will be added while creating the alert |
| `owner` | object | No | Sets the assignee of the alert. Display name of an existing JSM user |
| `plugin_name` | object | Yes | The Jira Service Management Operations plug-in. |
| `priority` | OpsGeniePriorityOneOf | No |  |
| `responsible_teams` | object | No | Team names that will be added as responders for the alert. The integration's ... |
| `source` | object | No | Source field of the alert. Default value is IP address of the incoming request |
| `tags` | object | No | Tags of the alert. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `affected_host_groups` | object | No | Enable/disable if we show affected host groups in the created message |
| `host_details` | object | No | Enable/disable the details for host notifications |
| `host_summary` | object | No | Enable/disable the summary for host notifications |
| `host_title` | object | No | Enable/disable the title for host notifications |
| `http_proxy` | object | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `plugin_name` | object | Yes | The MicrosoftTeams plug-in. |
| `service_details` | object | No | Enable/disable the details for service notifications |
| `service_summary` | object | No | Enable/disable the summary for service notifications |
| `service_title` | object | No | Enable/disable the title for service notifications |
| `url_prefix_for_links_to_checkmk` | UrlPrefixOneOf | No |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `actions` | object | No | Custom actions that will be available for the alert. You may paste a text fro... |
| `api_key` | OpsGenisStoreOrExplicitKeySelector | Yes |  |
| `desc_for_host_alerts` | object | No | Description field of host alert that is generally used to provide a detailed ... |
| `desc_for_service_alerts` | object | No | Description field of service alert that is generally used to provide a detail... |
| `disable_ssl_cert_verification` | object | No | Ignore unverified HTTPS request warnings. Use with caution. |
| `domain` | object | No | If you have an european account, please set the domain of your opsgenie. Spec... |
| `entity` | object | No | Is used to specify which domain the alert is related to |
| `extra_properties` | object | No | A list of extra properties that will be included in the notification |
| `http_proxy` | object | No | Use the proxy settings from the environment variables. The variables NO_PROXY... |
| `message_for_host_alerts` | object | No |  |
...
| `note_while_closing` | object | No | Additional note that will be added while closing the alert |
| `note_while_creating` | object | No | Additional note that will be added while creating the alert |
| `owner` | object | No | Sets the user of the alert. Display name of the request owner |
| `plugin_name` | object | Yes | The OpsGenie plug-in. |
| `priority` | OpsGeniePriorityOneOf | No |  |
| `responsible_teams` | object | No | Team names which will be responsible for the alert. If the API Key belongs to... |
| `source` | object | No | Source field of the alert. Default value is IP address of the incoming request |
| `tags` | object | No | Tags of the alert. You may paste a text from your clipboard which contains se... |
...
| `throttle_periodic_notifications` | ThorttlePeriodicNotificationsCheckbox | No |  |
