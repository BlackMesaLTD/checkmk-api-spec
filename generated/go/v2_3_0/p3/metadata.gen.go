...
var FieldDescriptions = map[string]map[string]string{
	...
	"CheckboxWithListOfCheckTypes": {
		"state": "To enable or disable this field",
		"value": "Only apply the rule if the notification originates from certain types of check plugins. Note: Host notifications never match this rule if this option is being used",
	},
