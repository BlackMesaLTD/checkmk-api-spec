...
var FieldDescriptions = map[string]map[string]string{
	...
	"Action": {
		"button": "Definition of the action button",
		"id": "The action id",
		"load_wait_label": "A string to display while waiting for the next stage",
	},
	"ActionResultObject": {
		"extensions": "Some attributes alongside the result.",
		"links": "list of links to other resources.",
		"result": "The result of the action. In this case, an object.",
		"resultType": "The type of the result.",
	},
	"ActionResultScalar": {
		"extensions": "Some attributes alongside the result.",
		"links": "list of links to other resources.",
		"result": "The scalar result of the action.",
		"resultType": "The type of the result.",
	},
	"ActivateChanges": {
	...
	"ActivationStatusResponse": {
		"domainType": "The domain type of the object.",
		"extensions": "The activation run attributes with status.",
		"id": "The unique identifier for this activation run.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "The activation run status.",
	...
	"AgentSign": {
		"key_id": "The id under that the desired agent signature key is stored",
		"passphrase": "The password to unlock the agent signature key",
	},
	"AlwaysBulk": {
	...
	"AuditLogEntry": {
		"extensions": "Data and Meta-Data of this audit log entry.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	},
	...
	"BIAggregationEndpoint": {
		"aggregation_visualization": "Aggregation visualization options.",
		"comment": "An optional comment that may be used to explain the purpose of this object.",
		"computation_options": "Computation options.",
	...
	"BIAggregationFunctionCountOK": {
		"levels_ok": "Required number of OK child nodes for total state of OK.",
		"levels_warn": "Required number of OK child nodes for total state of WARN.",
	...
	"BIHostSearch": {
		...
		"refer_to": "Create nodes based on the matched hosts, their parents or their children.",
		"type": "Host search.",
	},
	"BINodeGenerator": {
		"action": "Action on search results.",
	...
	"BINodeVisHierarchyStyle": {
		"style_config": "Configuration options for this style.",
	...
	"BIRuleEndpoint": {
		...
		"node_visualization": "Node visualization.",
	...
	"BackgroundJobStatus": {
		"log_info": "The logs of the background job",
	...
	"BaseSettingMode": {
		"mode": "With which mode to perform the license verification: 'online' or 'offline'. If 'online' is chosen, credentials have to be provided",
	},
	"BaseUserAttributes": {
	...
	"BrokerConnectionConfig": {
		"connectee": "The ID of the site accepting the connection.",
		"connecter": "The ID of the site initiating the connection.",
	},
	"BrokerConnectionExtension": {
		"connectee": "The attributes of the site accepting the connection.",
		"connecter": "The attributes of the site initiating the connection.",
	...
	"BrokerConnectionResponse": {
		"domainType": "The domain type of the object.",
		"extensions": "The configuration attributes of a broker peer to peer connection.",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"BuiltinCertificate": {
		"type": "Use the certificate that comes with Checkmk.",
	},
	"BulkCreateHost": {
	...
	"BulkDiscovery": {
		...
		"options": "The discovery options for the bulk discovery",
	},
	...
	"CheckMKURLPrefixValue": {
		"state": "To enable or disable this field",
		"value": "If you use Automatic HTTP/s, the URL prefix for host and service links within the notification is filled automatically. If you specify an URL prefix here, then several parts of the notification are armed with hyperlinks to your Check_MK GUI. In both cases, the recipient of the notification can di...",
	},
	"Checkbox": {
		"state": "To enable or disable this field",
	},
	"CheckboxEventConsoleAlerts": {
		"state": "To enable or disable this field",
		"value": "The Event Console can have events create notifications in Check_MK. These notifications will be processed by the rule based notification system of Check_MK. This matching option helps you distinguishing and also gives you access to special event fields",
	},
	...
	"ChildWith": {
		"conditions": "Extra conditions for the child.",
		"host_choice": "Child host selector.",
	...
	"ClusterCreateAttribute": {
		...
		"bake_agent_package": "Bake agent packages for this folder even if it is empty.",
	...
	"ConfigurationConnectionAttributesOutput": {
		...
		"is_trusted": "When this option is enabled the central site might get compromised by a rogue remote site. If you disable this option some features like rendering HTML in service descriptions will not work for services monitored on this site.",
		"message_broker_port": "The port used for the message broker to exchange messages.",
	...
	"ConfigurationConnectionWithoutReplicationAttributes": {
		"enable_replication": "Replication is disabled.",
	},
	"ConnectedSiteAttributes": {
		"site_id": "The site id.",
	},
	"ConnectionConfig": {
		"checkmk_server_url": "URL of the CheckMK server.",
		"identity_provider_metadata": "Identity provider metadata.",
		"identity_provider_timeout": "Configured timeouts.",
	},
	...
	"ContactGroupCnFromLdapDn": {
		"attribute": "Attribute for contact group sync.",
		"type": "The attribute value will be interpreted as a distinguished name (DN). The common name (CN) will be mapped to an existing contact group. If no such group exists, they will not be mapped.",
	},
	...
	"ContactGroupFromAttributeValue": {
		"attribute": "Attribute for contact group sync.",
		"type": "The attribute value will be mapped to an existing contact group with the same name. If no such group exists, they will not be mapped.",
	},
	"ContactGroupMapValue": {
		"attribute": "Attribute for contact group sync.",
		"mapping": "Mapping of attribute values to contact groups.",
		"type": "The attribute value will be compared to values in the mapping. The contact groups specified for that value will be applied.",
	},
	"ContactGroupMapping": {
		"attribute_value": "Value to compare to the attribute.",
	...
	"CreateCreationRuleAttribute": {
		"delete_hosts": "Delete the hosts created by this connection whose piggyback data is no longer present.",
		"folder_path": "Name of the folder the connection creates hosts in. Once created, you can choose to move the host to another folder. Path delimiters can be either `~`, `/` or `\\`. Please use the one most appropriate for your quoting/escaping needs. A good default choice is `~`.",
		"host_attributes": "Attributes to set on the newly created host.",
		"matching_hosts": "Restrict host creation using regular expressions.",
	},
	"CreateDCD": {
		"comment": "Add a comment to your dynamic host configuration",
		"connector": "The connector configuration.",
		"dcd_id": "The unique ID of the Piggyback dynamic host configuration to be created.",
		"disabled": "The dynamic host configuration can be disabled but will remain part of the site.",
		"documentation_url": "Add a URL linking to a documentation or any other page. You can use either global URLs (starting with http://), absolute local URLs (starting with /) or relative URLs (relative to check_mk/).",
		"site": "Specify the site where you want this connector to run. Only this site will process the data.",
		"title": "Name your connection for easy recognition.",
	},
	"CreateFolder": {
	...
	"CreatePiggybackDCD": {
		"connector_type": "The name of the plug-in to be used. Currently only piggyback is supported.",
		"creation_rules": "The first matching rule is used. You must specify at least one rule.",
		"discover_on_creation": "Automatically runs a service discovery on any new hosts created by this connection. This step will add any new services to the monitoring.",
		"interval": "The interval in seconds the connection will be executed to check the available piggyback and update the configuration.",
		"max_cache_age": "Seconds to keep hosts when piggyback source only sends piggyback data for other hosts.",
		"no_deletion_time_after_init": "Seconds to prevent host deletion after site startup, e.g. when booting the Checkmk server.",
		"restrict_source_hosts": "Only care about hosts that receive piggyback data from hosts which name matches one of these regular expressions.",
	...
	"CustomCertificate": {
		"certificate": "Public key in PEM format. Must be a single certificate, not a chain.",
		"private_key": "Private key in PEM format.",
		"type": "Specify a custom certificate.",
	},
	"CustomMacro": {
	...
	"CustomTimeRange": {
		"end": "The end datetime of the SLA compute period range. The format has to conform to the ISO 8601 profile",
		"range_type": "The type of the time range.",
		"start": "The start datetime of the SLA compute period range. The format has to conform to the ISO 8601 profile",
	},
	"DCDExtensions": {
		"comment": "Add a comment to your dynamic host configuration",
		"connector": "The connector configuration.",
		"dcd_id": "The unique identifier of the dynamic host configuration.",
		"disabled": "The dynamic host configuration can be disabled but will remain part of the site.",
		"documentation_url": "Add a URL linking to a documentation or any other page. You can use either global URLs (starting with http://), absolute local URLs (starting with /) or relative URLs (relative to check_mk/).",
		"site": "Specify the site where you want this connector to run. Only this site will process the data.",
		"title": "Name your connection for easy recognition.",
	...
	"DowntimeObject": {
		"domainType": "The domain type of the object.",
		"extensions": "The attributes of a downtime.",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"EditConfigurationEntityResponse": {
		...
		"extensions": "Response data for entity creation",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"FilterGraph": {
		"aggregation": "A result that contains multiple metrics of the same type can be aggregated together. Aggregation is disabled by default.",
		"filter": "Filter for hosts, services and sites. Entries of the filter are combined with logical AND. Depending of the configuration of Checkmk you have to specify a certain set of filters, otherwise Checkmk will refuse to return a result, as too many metrics would have to be returned. See example for commo...",
	...
	"GeneralProperties": {
		...
		"id": "A SAML connection ID string.",
		"name": "Display name for the SAML connection.",
	...
	"GetCustomGraph": {
		"custom_graph_id": "The ID of the requested custom graph.",
		"reduce": "Specify how to reduce a segment of data points to a single data point of the output metric. This can be useful to find spikes in your data that would be smoothed out by computing the average.",
		"time_range": "The time range from which to source the metrics.",
	},
	"GetGraph": {
	...
	"GraphCollection": {
		...
		"time_range": "The time range within the samples of the response lie.",
	},
	...
	"HostDowntimeAttributes": {
		...
		"mode": "The mode of the downtime, either fixed or flexible.",
	...
	"HttpProxyValue": {
		"state": "To enable or disable this field",
		"value": "Use the proxy settings from the environment variables. The variables NO_PROXY, HTTP_PROXY and HTTPS_PROXY are taken into account during execution. Have a look at the python requests module documentation for further information. Note that these variables must be defined as a site-user in ~/etc/env...",
	},
	"IPAddressRange": {
	...
	"IdpMetadataURL": {
		"type": "Automatically determine identity provider metadata by querying an endpoint.",
		"url": "URL to fetch identity provider metadata from.",
	},
	"IdpMetadataXML": {
		"type": "Static configuration in XML format.",
		"xml": "Identity provider metadata xml.",
	},
	"IdpTimeout": {
	...
	"InventoryPathSpecificPath": {
		"attributes": "Restrict single values.",
		"columns": "Restrict table columns.",
		"nodes": "Restrict subcategories.",
	...
	"JiraPluginCreate": {
		"auth": "The authentication credentials for the Jira connection",
		"disable_ssl_cert_verification": "Ignore unverified HTTPS request warnings. Use with caution.",
		"graphs_per_notification": "Here you can set a limit for the number of graphs that are displayed in a notification. If not set, 0 will be used",
	...
	"LDAPConnection": {
		"bind_credentials": "The credentials used to connect to the LDAP server.",
		"connect_timeout": "If the connection timeout is set and its value.",
		"connection_suffix": "If the connection suffix is enabled and what its set to.",
		"directory_type": "The credentials to be used to connect to the LDAP server. The used account must not be allowed to do any changes in the directory the whole connection is read only. In some environment an anonymous connect/bind is allowed, in this case you don't have to configure anything here.It must be possible...",
		"ldap_version": "If the ldap version is set and the version it's set to. Either 2 or 3.",
		"page_size": "If the page size is enabled and its value.",
		"response_timeout": "Enable the response timeout and define its value.",
		...
		"tcp_port": "The TCP port to be used to connect to the LDAP server.",
	},
	"LDAPConnectionConfigCreateRequest": {
		"general_properties": "General properties of an LDAP connection.",
		"groups": "The LDAP group configuration",
		"ldap_connection": "The LDAP connection configuration",
		"other": "Other config options for the LDAP connection.",
		"sync_plugins": "The LDAP sync plug-ins configuration",
		"users": "The LDAP user configuration",
	},
	...
	"LDAPConnectionCreateRequest": {
		...
		"connection_suffix": "If the connection suffix is enabled and what its set to.",
		"directory_type": "The credentials to be used to connect to the LDAP server. The used account must not be allowed to do any changes in the directory the whole connection is read only. In some environment an anonymous connect/bind is allowed, in this case you don't have to configure anything here.It must be possible...",
		"ldap_version": "If the ldap version is set and the version it's set to.",
		"page_size": "If the page size is enabled and its value.",
		"response_timeout": "Enable the response timeout and define its value.",
		"ssl_encryption": "Connect to the LDAP server with a SSL encrypted connection. The trusted certificates authorities configured in Checkmk will be used to validate the certificate provided by the LDAP server.",
		"tcp_port": "The TCP port to be used to connect to the LDAP server.",
	...
	"LDAPConnectionResponse": {
		"domainType": "The domain type of the object.",
		"extensions": "The configuration attributes of a user LDAP connection.",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"LDAPDisableNotificationsValue": {
		"custom_time_range": "Here you can specify a time range where no notifications are generated.",
	...
	"LDAPGroups": {
		...
		"member_attribute": "Enable and define a member attribute.",
		"search_filter": "Enable and define an optional LDAP filter.",
	...
	"LDAPOther": {
		"sync_interval": "This option defines the interval of the LDAP synchronization. This setting is only used by sites which have the automatic user synchronization enabled.",
	},
	"LDAPOtherRequest": {
		"sync_interval": "This option defines the interval of the LDAP synchronization. This setting is only used by sites which have the automatic user synchronization enabled.",
	},
	...
	"LDAPSyncPluginsRequestWithCustomAttributes": {
		"alias": "Enables and populates the alias attribute of the Setup user by synchronizing an attribute from the LDAP user account. By default the LDAP attribute cn is used.",
		"authentication_expiration": "This plug-in when enabled fetches all information which is needed to check whether or not an already authenticated user should be deauthenticated, e.g. because the password has changed in LDAP or the account has been locked.",
		"contact_group_membership": "This plug-in allows you to synchronize group memberships of the LDAP user account into the contact groups of the Checkmk user account. This allows you to use the group based permissions of your LDAP directory in Checkmk.",
		"disable_notifications": "When this option is enabled you will not get any alerts or other notifications via email, SMS or similar. This overrides all other notification settings and rules, so make sure that you know what you do. Moreover you can specify a time range where no notifications are generated.",
		"email_address": "Synchronizes the email of the LDAP user account into Checkmk when enabled",
		"groups_to_custom_user_attributes": "This plug-in allows you to synchronize group memberships of the LDAP user account into the custom attributes of the Checkmk user account. This allows you to use the group based permissions of your LDAP directory in Checkmk.",
		"groups_to_roles": "Configures the roles of the user depending on its group memberships in LDAP. Please note: Additionally the user is assigned to the Default Roles. Deactivate them if unwanted.",
		"mega_menu_icons": "When enabled, in the mega menus you can select between two options: Have a green icon only for the headlines – the 'topics' – for lean design. Or have a colored icon for every entry so that over time you can zoom in more quickly to a specific entry.",
		"navigation_bar_icons": "With this option enabled you can define if icons in the navigation bar should show a title or not. This gives you the possibility to save some space in the UI.",
		"pager": "When enabled, this plug-in synchronizes a field of the users LDAP account to the pager attribute of the Setup user accounts, which is then forwarded to the monitoring core and can be used for notifications. By default the LDAP attribute mobile is used.",
		"show_mode": "In some places like e.g. the main menu Checkmk divides features, filters, input fields etc. in two categories, showing more or less entries. With this option you can set a default mode for unvisited menus. Alternatively, you can enforce to show more, so that the round button with the three dots i...",
		"start_url": "The start URL to display in main frame.",
		"temperature_unit": "Set the temperature unit used for graphs and perfometers. The default unit can be configured here. Note that this setting does not affect the temperature unit used in service outputs, which can however be configured in this ruleset.",
		"ui_sidebar_position": "The sidebar position",
		"ui_theme": "The user interface theme",
		"visibility_of_hosts_or_services": "When this option is checked, the status GUI will only display hosts and services that the user is a contact for - even they have the permission for seeing all objects.",
	},
	"LDAPSyncPluginsWithCustomAttributes": {
		"alias": "Populates the alias attribute of the Setup user by synchronizing an attribute from the LDAP user account. By default the LDAP attribute cn is used.",
		"authentication_expiration": "This plug-in fetches all information which are needed to check whether or not an already authenticated user should be deauthenticated, e.g. because the password has changed in LDAP or the account has been locked.",
		"contact_group_membership": "Adds the user to contact groups based on the group memberships in LDAP. This plug-in adds the user only to existing contact groups while the name of the contact group must match the common name (cn) of the LDAP group.",
		"disable_notifications": "When this option is active you will not get any alerts or other notifications via email, SMS or similar. This overrides all other notification settings and rules, so make sure that you know what you do. Moreover you can specify a time range where no notifications are generated.",
		"email_address": "Synchronizes the email of the LDAP user account into Checkmk",
		"groups_to_custom_user_attributes": "Sets custom user attributes based on the group memberships in LDAP. This plug-in can be used to set custom user attributes to specified values for all users which are member of a group in LDAP. The specified group name must match the common name (CN) of the LDAP group.",
		"groups_to_roles": "Configures the roles of the user depending on its group memberships in LDAP.",
		"mega_menu_icons": "In the mega menus you can select between two options: Have a green icon only for the headlines – the 'topics' – for lean design. Or have a colored icon for every entry so that over time you can zoom in more quickly to a specific entry.",
		"navigation_bar_icons": "With this option you can define if icons in the navigation bar should show a title or not. This gives you the possibility to save some space in the UI.",
		"pager": "This plug-in synchronizes a field of the users LDAP account to the pager attribute of the Setup user accounts, which is then forwarded to the monitoring core and can be used for notifications. By default the LDAP attribute mobile is used.",
		"show_mode": "In some places like e.g. the main menu Checkmk divides features, filters, input fields etc. in two categories, showing more or less entries. With this option you can set a default mode for unvisited menus. Alternatively, you can enforce to show more, so that the round button with the three dots i...",
		"start_url": "The start URL to display in main frame.",
		"temperature_unit": "Set the temperature unit used for graphs and perfometers. The default unit can be configured here. Note that this setting does not affect the temperature unit used in service outputs, which can however be configured in this ruleset.",
		"ui_sidebar_position": "The sidebar position",
		"ui_theme": "The user interface theme",
		"visibility_of_hosts_or_services": "When this option is checked, the status GUI will only display hosts and services that the user is a contact for - even if they have the permission for seeing all objects.",
	},
	"LDAPTCPPortRequest": {
	...
	"LDAPUsers": {
		...
		"filter_group": "Enable and define the DN of a group object which is used to filter the users.",
		"search_filter": "Enable and define an optional LDAP filter.",
		...
		"user_id_attribute": "Enable and define a user ID attribute.",
	...
	"Levels": {
		"crit": "The critical level of the SLA agreement.",
		"warn": "The warning level of the SLA agreement.",
	},
	"LicenseSettings": {
		"settings": "The settings required for the configuration of licensing settings",
	},
	"Link": {
	...
	"Metadata": {
		"assertion_consumer_service_endpoint": "Assertion Consumer Service endpoint for this connection.",
		"entity_id": "Entity ID for this connection.",
		"metadata_endpoint": "Metadata endpoint for this connection.",
	},
	"Metric": {
	...
	"ModifyDowntimeByHostGroup": {
		...
		"end_time": "The option how to modify the end time of a downtime. If modify_type is set to 'absolute', then the end time will be set to the date time specified in the value field. If modify_type is set to 'relative', then the current end time will be modified by the amount of minutes specified in the value fi...",
	...
	"MonitoringLevels": {
		"levels": "The levels of the SLA agreement.",
		"limit": "The limit of the SLA agreement.",
	},
	"MoveFolder": {
	...
	"OnlineSettingMode": {
		"credentials": "The credentials to use for online license configuration",
		"mode": "With which mode to perform the license verification: 'online' or 'offline'. If 'online' is chosen, credentials have to be provided",
	},
	"OpsGeniePluginCreate": {
		...
		"extra_properties": "A list of extra properties that will be included in the notification",
		"http_proxy": "Use the proxy settings from the environment variables. The variables NO_PROXY, HTTP_PROXY and HTTPS_PROXY are taken into account during execution.",
	...
	"ParentScan": {
		"configuration": "Parent scan configuration options",
		"gateway_hosts": "Creation of gateway hosts options",
		"host_names": "Targeted hosts for parent scan.",
		"performance": "Parent scan performance related options",
	},
	"PasswordCollection": {
		"domainType": "The domain type of the objects in the collection.",
		"extensions": "Additional attributes alongside the collection.",
	...
	"PluginPercentageStateComputedResult": {
		"period_results": "The period results of the service percentage state computation plugin.",
		"plugin_id": "The id of the plugin.",
		"time_range_sla_duration": "The duration of the time range in seconds.",
	},
	"PluginWithParams": {
	...
	"PreDefinedTimeRange": {
		"range": "The pre-defined time range.",
		"range_type": "The type of the time range.",
	},
	"Properties": {
	...
	"PushOverPriority": {
		"state": "To enable or disable this field",
		"value": "The pushover priority level",
	},
	...
	"QuickSetupCompleteResponse": {
		...
		"background_job_exception": "The exception details if the action was run in the background and raised an unexpected exception",
	...
	"Request": {
		"parameters": "Parameters related to the autocompleter being invoked",
	...
	"RolesMap": {
		"attribute": "Attribute which will be checked for a match.",
		"roles": "Mapping of roles and attribute values. Roles will be added to the user if one of the values matches the attribute value.",
	},
	"RuleCollection": {
	...
	"SAMLConnectionConfig": {
		"connection_config": "SAML connection configuration.",
		"general_properties": "General properties of a SAML connection.",
		"metadata": "Generated service provider metadata.",
		"security": "SAML security configuration.",
		"users": "User sync configuration.",
	},
	...
	"SAMLConnectionResponse": {
		"domainType": "The domain type of the object.",
		"extensions": "The configuration attributes of a user SAML connection.",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"SAMLConnectionResponseCollection": {
		...
		"links": "list of links to other resources.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
		"value": "A list of SAML connections.",
	},
	"SLAComputeRequest": {
		"sla_compute_targets": "The SLA compute targets for which the SLA should be computed.",
	},
	"SLAComputeResult": {
		"results": "The period results of the SLA computation.",
		"service": "The service entity for which the SLA is computed.",
		"sla_id": "The ID of the SLA.",
		"sla_period": "The configured SLA period.",
		"time_range": "The time range for which the SLA is computed.",
	},
	"SLAComputeTarget": {
		"services": "The services for which the SLA should be computed.",
		"sla_ids": "The ids of the SLA configurations for which the SLA should be computed.",
		"time_ranges": "The time ranges for which the SLA should be computed.",
	},
	"SLAComputedResultCollection": {
		"domainType": "The domain type of the objects in the collection",
		"value": "The list of SLA computed results.",
	},
	"SMSAPIPStoreID": {
		"store_id": "A password store ID",
	},
	...
	"Security": {
		"decrypt_auth_certificate": "Certificate to decrypt authentication responses.",
		"signing_certificate": "Certificate to sign requests to the identity provider.",
	},
	"Service": {
		"service_description": "The service whose SLA data is to be computed.",
	},
	"ServiceConditions": {
		"host_choice": "Host selection.",
		"host_folder": "Host folder.",
	...
	"ServiceNowPluginCreate": {
		"auth": "The authentication credentials for the ServiceNow connection",
		"http_proxy": "Use the proxy settings from the environment variables. The variables NO_PROXY, HTTP_PROXY and HTTPS_PROXY are taken into account during execution.",
		"plugin_name": "The plug-in name.",
	...
	"ServiceOutput": {
		"host_name": "The name of the host.",
		"service_description": "The description of the service for which the SLA is computed.",
	...
	"ServicePercentagePeriodResult": {
		"duration": "The duration of the time range in seconds.",
		"sla_agreement": "Whether the SLA agreement was broken or fulfilled during this period.The agreement is considered broken if at least one agreement of the defined state configurations was broken.",
		"state_durations": "The percentage of the duration for which the service was in the underlying states",
		"sub_results": "The sub results of the service state percentage period result.",
		"time_range": "The time range of the period.",
	},
	"ServiceStatePercentageConfig": {
		"monitoring_levels": "The monitoring levels for which the SLA agreement is checked.",
		"state_requirement": "The configured state for which the SLA agreement is checked.",
	},
	"ServiceStatePercentageStateRequirement": {
		"condition": "The reference condition for which the observed state is compared to.",
		"observed_percentage": "The reference percentage value for which the condition is checked.",
		"observed_state": "The configured state for which the SLA agreement is checked.",
	},
	"ServiceStatePercentageSubResult": {
		"state": "The state of the SLA agreement",
	},
	"ShowDCD": {
		"domainType": "The domain type of the object.",
		"extensions": "All the data and metadata of this dcd connection.",
		"id": "The unique identifier for this domain-object type.",
		"links": "list of links to other resources.",
		"members": "The container for external resources, like linked foreign objects or actions.",
		"title": "A human readable title of this object. Can be used for user interfaces.",
	...
	"StateDurations": {
		"crit": "The time duration for how long the service was in the CRIT state.",
		"ok_indowntime": "The time duration for how long the service was in the OK state or in downtime.",
		"unknown_unmonitored": "The time duration for how long the service was in the UNKNOWN state or unmonitored.",
		"warn": "The time duration for how long the service was in the WARN state.",
	},
	"StateSubResult": {
		"deviation_state": "The deviation state of the SLA agreement. The deviation state is respective to the configured warn and crit levels and the determined deviation value.",
		"deviation_value": "The deviation value of the SLA agreement. The deviation value is the difference between the observed and computed value. The meaning differs depending on the configured SLA computation type.",
		"sla_agreement": "Whether the SLA agreement was broken or fulfilled during this period.The agreement is considered broken if at least one agreement of the defined state configurations was broken.",
	},
	...
	"ToEmailAndNameCheckbox": {
		"state": "To enable or disable this field",
		"value": "The email address and visible name used in the Reply-To header of notifications messages",
	},
	"TranslateNames": {
	...
	"Users": {
		"contact_groups": "Contact group sync configuration.",
		"email_attribute": "Attribute used for the email.",
		"full_name_attribute": "Attribute used for the full name, if not set the ID is used.",
		"id_attribute": "Attribute used to uniquely identify the users.",
		"roles": "Role sync configuration.",
	},
	"ValidationMessage": {
	...
	"VerificationResponse": {
		...
		"certificate": "The certificate of the response",
...
var FieldTypes = map[string]map[string]string{
	...
	"CreatePiggybackDCD": {
		...
		"no_deletion_time_after_init": "integer",
		"restrict_source_hosts": "array",
...
func IsReadOnlyField(schemaName, fieldName string) bool {
	...
	case "PasswordExtension":
		for _, f := range PasswordExtensionReadOnlyFieldNames {
			if f == fieldName {
				return true
			}
		}
...
func IsRequiredField(schemaName, fieldName string) bool {
	...
	case "ActionResultObject":
		for _, f := range ActionResultObjectRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ActionResultObjectValue":
		for _, f := range ActionResultObjectValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ActionResultScalar":
		for _, f := range ActionResultScalarRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ActionResultScalarValue":
		for _, f := range ActionResultScalarValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "AgentCollection":
		for _, f := range AgentCollectionRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "AgentObject":
		for _, f := range AgentObjectRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "AgentSign":
		for _, f := range AgentSignRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "BaseSettingMode":
		for _, f := range BaseSettingModeRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "BuiltinCertificate":
		for _, f := range BuiltinCertificateRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CheckMKURLPrefixValue":
		for _, f := range CheckMKURLPrefixValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CheckboxSysLogFacilityToUseValue":
		for _, f := range CheckboxSysLogFacilityToUseValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CheckboxWithManagementTypeStateCaseValues":
		for _, f := range CheckboxWithManagementTypeStateCaseValuesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "CheckboxWithManagementTypeStateIncedentValues":
		for _, f := range CheckboxWithManagementTypeStateIncedentValuesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CheckboxWithSysLogFacility":
		for _, f := range CheckboxWithSysLogFacilityRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ConfigurationConnectionWithReplicationAttributes":
		for _, f := range ConfigurationConnectionWithReplicationAttributesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ConfigurationConnectionWithoutReplicationAttributes":
		for _, f := range ConfigurationConnectionWithoutReplicationAttributesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ConnectionConfig":
		for _, f := range ConnectionConfigRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ConnectionFetchPhaseOne":
		for _, f := range ConnectionFetchPhaseOneRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ContactGroupCnFromLdapDn":
		for _, f := range ContactGroupCnFromLdapDnRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ContactGroupFromAttributeValue":
		for _, f := range ContactGroupFromAttributeValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ContactGroupMapValue":
		for _, f := range ContactGroupMapValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ContactGroupMapping":
		for _, f := range ContactGroupMappingRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CreateDCD":
		for _, f := range CreateDCDRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CreatePiggybackDCD":
		for _, f := range CreatePiggybackDCDRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CustomCertificate":
		for _, f := range CustomCertificateRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "CustomPluginWithParams":
		for _, f := range CustomPluginWithParamsRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "DCDExtensions":
		for _, f := range DCDExtensionsRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "EnableSynchronousDeliveryViaSMTPValue":
		for _, f := range EnableSynchronousDeliveryViaSMTPValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "FilterGraph":
		for _, f := range FilterGraphRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "FilterMetric":
		for _, f := range FilterMetricRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "GeneralProperties":
		for _, f := range GeneralPropertiesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "GeneralPropertiesCreate":
		for _, f := range GeneralPropertiesCreateRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "GetCustomGraph":
		for _, f := range GetCustomGraphRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "HtmlSectionBetweenBodyAndTableCheckbox":
		for _, f := range HtmlSectionBetweenBodyAndTableCheckboxRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "HttpProxyValue":
		for _, f := range HttpProxyValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "IdpMetadataURL":
		for _, f := range IdpMetadataURLRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "IdpMetadataXML":
		for _, f := range IdpMetadataXMLRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "LDAPGroupsToRolesRequestWithCustomRoles":
		for _, f := range LDAPGroupsToRolesRequestWithCustomRolesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "LicenseCredentials":
		for _, f := range LicenseCredentialsRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "LicenseSettings":
		for _, f := range LicenseSettingsRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ListOfExtraProperties":
		for _, f := range ListOfExtraPropertiesRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "Metadata":
		for _, f := range MetadataRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "NotificationBulkingValue":
		for _, f := range NotificationBulkingValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "OnlineSettingMode":
		for _, f := range OnlineSettingModeRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "OutsideTimeperiodValue":
		for _, f := range OutsideTimeperiodValueRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "PluginPercentageStateComputedResult":
		for _, f := range PluginPercentageStateComputedResultRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "PluginWithoutParams":
		for _, f := range PluginWithoutParamsRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "PreDefinedTimeRange":
		for _, f := range PreDefinedTimeRangeRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ProxyAttributesOutput":
		for _, f := range ProxyAttributesOutputRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "RolesMap":
		for _, f := range RolesMapRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "SAMLConnectionConfig":
		for _, f := range SAMLConnectionConfigRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SAMLConnectionCreateRequest":
		for _, f := range SAMLConnectionCreateRequestRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SAMLConnectionResponse":
		for _, f := range SAMLConnectionResponseRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SAMLConnectionResponseCollection":
		for _, f := range SAMLConnectionResponseCollectionRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SLAComputeRequest":
		for _, f := range SLAComputeRequestRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SLAComputeTarget":
		for _, f := range SLAComputeTargetRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "Service":
		for _, f := range ServiceRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ServicePercentagePeriodResult":
		for _, f := range ServicePercentagePeriodResultRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ShowDCD":
		for _, f := range ShowDCDRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "SocketAttributesOutput":
		for _, f := range SocketAttributesOutputRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "StateSubResult":
		for _, f := range StateSubResultRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "StatusConnectionAttributesOutput":
		for _, f := range StatusConnectionAttributesOutputRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "SubjectForHostNotificationsCheckbox":
		for _, f := range SubjectForHostNotificationsCheckboxRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "SubjectForServiceNotificationsCheckbox":
		for _, f := range SubjectForServiceNotificationsCheckboxRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "TimeRange2":
		for _, f := range TimeRange2RequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "TimeRangeOutput":
		for _, f := range TimeRangeOutputRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "ToEmailAndNameCheckbox":
		for _, f := range ToEmailAndNameCheckboxRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "UserSyncAttributesOutput":
		for _, f := range UserSyncAttributesOutputRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "Users":
		for _, f := range UsersRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	case "VerificationResponse":
		for _, f := range VerificationResponseRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
...
func IsDeprecatedField(schemaName, fieldName string) bool {
	...
	case "InputPassword":
		for _, f := range InputPasswordDeprecatedFieldNames {
			if f == fieldName {
				return true
			}
		}
