...
var FieldDescriptions = map[string]map[string]string{
	...
	"JsmOperationsPluginCreate": {
		...
		"additional_responders": "Additional non-team responders (user, on-call schedule, escalation policy) to attach to the alert.",
		...
		"owner": "Sets the assignee of the alert. Display name of an existing JSM user",
		"plugin_name": "The Jira Service Management Operations plug-in.",
		"responsible_teams": "Team names that will be added as responders for the alert. The integration's own team is always implicitly responsible; entries here add additional teams.",
...
func IsRequiredField(schemaName, fieldName string) bool {
	...
	case "LDAPGroupsToRolesRequest":
		for _, f := range LDAPGroupsToRolesRequestRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
