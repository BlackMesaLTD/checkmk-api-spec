...
var FieldDescriptions = map[string]map[string]string{
	...
	"CustomPlugin": {
		"plugin_name": "The custom plugin name",
	},
	...
	"PluginBase": {
		"plugin_params": "The plugin name and configuration parameters defined.",
	},
...
func IsRequiredField(schemaName, fieldName string) bool {
	...
	case "CustomTimeRange1":
		for _, f := range CustomTimeRange1RequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "FromToServiceLevels1":
		for _, f := range FromToServiceLevels1RequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "TimeRange3":
		for _, f := range TimeRange3RequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
