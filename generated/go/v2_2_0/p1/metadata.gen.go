...
func IsRequiredField(schemaName, fieldName string) bool {
	...
	case "ContactGroupObject":
		for _, f := range ContactGroupObjectRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "HostGroupObject":
		for _, f := range HostGroupObjectRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
	...
	case "ServiceGroupObject":
		for _, f := range ServiceGroupObjectRequiredFieldNames {
			if f == fieldName {
				return true
			}
		}
