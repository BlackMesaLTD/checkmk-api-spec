...
var UnionDescriptions = map[string]map[string]UnionField{
	...
	"BaseUserAttributes": {
		...
		"customer": {
			Description: "[Only in editions: Ultimate with multi-tenancy] By specifying a customer, you configure on which sites the user object will be available. 'global' will make the object available on all sites. This field is required for the following editions: Ultimate with multi-tenancy.",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
	...
	"ClusterCreateAttribute": {
		...
		"bake_agent_package": {
			Description: "[Only in editions: all commercial editions] Bake agent packages for this folder even if it is empty.",
			Type:        "boolean",
			MinVersion:  "2.2",
			MaxVersion:  "2.5",
		},
		"cmk_agent_connection": {
			Description: "[Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] This configures the communication direction of this host. * `pull-agent` (default) - The server will try to contact the monitored host and pull the data by initializing a TCP connection * `push-agent` - the host is expected to send ...",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
		...
		"relay": {
			Description: "[Only in editions: Ultimate, Ultimate with multi-tenancy, Cloud] The relay ID through which this host is monitored, if not empty.",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
	...
	"ContactGroupExtensions": {
		"customer": {
			Description: "[Only in editions: Ultimate with multi-tenancy] The customer for which the object is configured. This field is required for the following editions: Ultimate with multi-tenancy.",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
	...
	"CreateHostDowntime": {
		...
		"recur": {
			Description: "The recurring mode of the new downtime. Available modes are: * fixed * hour * day * week * second_week * fourth_week * weekday_start * weekday_end * day_of_month This only works in the commercial editions of Checkmk. Defaults to 'fixed'.",
			Type:        "string",
			MinVersion:  "2.2",
			MaxVersion:  "",
		},
	...
	"CreateUser": {
		...
		"customer": {
			Description: "[Only in editions: Ultimate with multi-tenancy] By specifying a customer, you configure on which sites the user object will be available. 'global' will make the object available on all sites.",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
	...
	"SNMPv3AuthPrivacy": {
		...
		"privacy_protocol": {
			Description: "The privacy protocol. The only supported values in Checkmk Community are CBC-DES and AES-128. If selected, privacy_password needs to be supplied as well.",
			Type:        "string",
			MinVersion:  "2.2",
			MaxVersion:  "",
		},
	...
	"StatusConnectionModel": {
		...
		"url_prefix": {
			Description: "The URL prefix will be prepended to links of add-ons like NagVis when a link to such applications points to a host or service on that site.",
			Type:        "string",
			MinVersion:  "2.5",
			MaxVersion:  "",
		},
