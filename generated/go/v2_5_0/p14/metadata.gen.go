...
var FieldDescriptions = map[string]map[string]string{
	...
	"EventConsoleAlertAttributes": {
		"match_type": "How this rule treats Event Console alerts. `match_only_event_console_alerts`: Event Console alerts match this rule. If at least one filter is set in `values`, the rule matches Event Console alerts exclusively and host and service notifications no longer match it. Without any filter, Event Console...",
	},
	...
	"PagerDutyPluginCreate": {
		...
		"webhook_url": "PagerDuty Events API v2 endpoint to post incidents to. Pick the URL matching the PagerDuty region (US or EU) your account belongs to.",
	},
	"Params": {
